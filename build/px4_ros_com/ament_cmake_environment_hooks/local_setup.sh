...
: ${AMENT_CURRENT_PREFIX:="/home/ctuav/ctuav_gazebo-research/install/px4_ros_com"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_ros_com/environment/pythonpath.sh"
