...
execute_process(
  COMMAND "/usr/bin/git" show-ref "d04b964d82ed5146f7e5e34701a5ba69f9514c9a"
  WORKING_DIRECTORY "/home/ctuav/ctuav_gazebo-research/build/px4/_deps/abseil-cpp-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "d04b964d82ed5146f7e5e34701a5ba69f9514c9a")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("d04b964d82ed5146f7e5e34701a5ba69f9514c9a" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/d04b964d82ed5146f7e5e34701a5ba69f9514c9a")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ctuav/ctuav_gazebo-research/build/px4/_deps/abseil-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ctuav/ctuav_gazebo-research/build/px4/_deps/abseil-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
