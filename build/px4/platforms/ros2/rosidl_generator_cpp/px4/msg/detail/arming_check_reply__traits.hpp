...
#ifndef PX4__MSG__DETAIL__ARMING_CHECK_REPLY__TRAITS_HPP_
#define PX4__MSG__DETAIL__ARMING_CHECK_REPLY__TRAITS_HPP_
...
// Member 'events'
#include "px4/msg/detail/event__traits.hpp"
...
inline void to_yaml(
  const px4::msg::ArmingCheckReply & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::ArmingCheckReply & msg)
{
  return px4::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4::msg::ArmingCheckReply>()
{
  return "px4::msg::ArmingCheckReply";
}

template<>
inline const char * name<px4::msg::ArmingCheckReply>()
{
  return "px4/msg/ArmingCheckReply";
}

template<>
struct has_fixed_size<px4::msg::ArmingCheckReply>
  : std::integral_constant<bool, has_fixed_size<px4::msg::Event>::value> {};

template<>
struct has_bounded_size<px4::msg::ArmingCheckReply>
  : std::integral_constant<bool, has_bounded_size<px4::msg::Event>::value> {};

template<>
struct is_message<px4::msg::ArmingCheckReply>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4__MSG__DETAIL__ARMING_CHECK_REPLY__TRAITS_HPP_
