...
#ifndef PX4__MSG__DETAIL__VEHICLE_IMU__STRUCT_HPP_
#define PX4__MSG__DETAIL__VEHICLE_IMU__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__VehicleImu __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__VehicleImu __declspec(deprecated)
#endif
...
struct VehicleImu_
{
  ...
  explicit VehicleImu_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->delta_angle_dt = 0ul;
      this->delta_velocity_dt = 0ul;
  ...
  // pointer types
  using RawPtr =
    px4::msg::VehicleImu_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::VehicleImu_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::VehicleImu_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::VehicleImu_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::VehicleImu_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleImu_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleImu_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::VehicleImu_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::VehicleImu_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__VehicleImu
    std::shared_ptr<px4::msg::VehicleImu_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__VehicleImu
    std::shared_ptr<px4::msg::VehicleImu_<ContainerAllocator> const>
...
using VehicleImu =
  px4::msg::VehicleImu_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__VEHICLE_IMU__STRUCT_HPP_
