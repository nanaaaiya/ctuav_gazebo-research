...
#ifndef PX4__MSG__DETAIL__ROVER_SPEED_STATUS__STRUCT_HPP_
#define PX4__MSG__DETAIL__ROVER_SPEED_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__RoverSpeedStatus __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__RoverSpeedStatus __declspec(deprecated)
#endif
...
struct RoverSpeedStatus_
{
  using Type = RoverSpeedStatus_<ContainerAllocator>;

  explicit RoverSpeedStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit RoverSpeedStatus_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    px4::msg::RoverSpeedStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::RoverSpeedStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::RoverSpeedStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__RoverSpeedStatus
    std::shared_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__RoverSpeedStatus
    std::shared_ptr<px4::msg::RoverSpeedStatus_<ContainerAllocator> const>
  ...
  bool operator==(const RoverSpeedStatus_ & other) const
  {
...
using RoverSpeedStatus =
  px4::msg::RoverSpeedStatus_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__ROVER_SPEED_STATUS__STRUCT_HPP_
