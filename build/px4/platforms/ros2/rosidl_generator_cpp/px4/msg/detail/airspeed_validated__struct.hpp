...
#ifndef PX4__MSG__DETAIL__AIRSPEED_VALIDATED__STRUCT_HPP_
#define PX4__MSG__DETAIL__AIRSPEED_VALIDATED__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__AirspeedValidated __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__AirspeedValidated __declspec(deprecated)
#endif
...
struct AirspeedValidated_
{
  ...
  static constexpr int8_t DISABLED =
    -1;
  static constexpr int8_t GROUND_MINUS_WIND =
    0;
  static constexpr int8_t SENSOR_1 =
    1;
  static constexpr int8_t SENSOR_2 =
    2;
  static constexpr int8_t SENSOR_3 =
    3;
  static constexpr int8_t SYNTHETIC =
    4;

  // pointer types
  using RawPtr =
    px4::msg::AirspeedValidated_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::AirspeedValidated_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::AirspeedValidated_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::AirspeedValidated_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::AirspeedValidated_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::AirspeedValidated_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::AirspeedValidated_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::AirspeedValidated_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::AirspeedValidated_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__AirspeedValidated
    std::shared_ptr<px4::msg::AirspeedValidated_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__AirspeedValidated
    std::shared_ptr<px4::msg::AirspeedValidated_<ContainerAllocator> const>
...
using AirspeedValidated =
  px4::msg::AirspeedValidated_<std::allocator<void>>;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr int8_t AirspeedValidated_<ContainerAllocator>::DISABLED;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr int8_t AirspeedValidated_<ContainerAllocator>::GROUND_MINUS_WIND;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr int8_t AirspeedValidated_<ContainerAllocator>::SENSOR_1;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr int8_t AirspeedValidated_<ContainerAllocator>::SENSOR_2;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr int8_t AirspeedValidated_<ContainerAllocator>::SENSOR_3;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr int8_t AirspeedValidated_<ContainerAllocator>::SYNTHETIC;
#endif  // __cplusplus < 201703L
...
#endif  // PX4__MSG__DETAIL__AIRSPEED_VALIDATED__STRUCT_HPP_
