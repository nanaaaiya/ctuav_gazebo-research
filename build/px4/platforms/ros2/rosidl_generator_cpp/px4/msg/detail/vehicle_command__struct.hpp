...
#ifndef PX4__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_HPP_
#define PX4__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__VehicleCommand __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__VehicleCommand __declspec(deprecated)
#endif
...
struct VehicleCommand_
{
  ...
  static constexpr uint16_t VEHICLE_CMD_REQUEST_MESSAGE =
    512u;
  static constexpr uint16_t VEHICLE_CMD_REQUEST_CAMERA_INFORMATION =
    521u;
  ...
  // pointer types
  using RawPtr =
    px4::msg::VehicleCommand_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::VehicleCommand_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::VehicleCommand_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::VehicleCommand_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::VehicleCommand_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleCommand_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleCommand_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::VehicleCommand_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::VehicleCommand_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__VehicleCommand
    std::shared_ptr<px4::msg::VehicleCommand_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__VehicleCommand
    std::shared_ptr<px4::msg::VehicleCommand_<ContainerAllocator> const>
...
using VehicleCommand =
  px4::msg::VehicleCommand_<std::allocator<void>>;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t VehicleCommand_<ContainerAllocator>::VEHICLE_CMD_REQUEST_CAMERA_INFORMATION;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
...
#endif  // PX4__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_HPP_
