...
{
public:
  explicit Init_ActuatorArmed_termination(::px4::msg::ActuatorArmed & msg)
  : msg_(msg)
  {}
  Init_ActuatorArmed_in_esc_calibration_mode termination(::px4::msg::ActuatorArmed::_termination_type arg)
  {
...
{
public:
  explicit Init_ActuatorArmed_kill(::px4::msg::ActuatorArmed & msg)
  : msg_(msg)
  {}
  Init_ActuatorArmed_termination kill(::px4::msg::ActuatorArmed::_kill_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_ActuatorArmed_kill lockdown(::px4::msg::ActuatorArmed::_lockdown_type arg)
  {
