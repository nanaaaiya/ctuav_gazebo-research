...
#ifndef PX4__MSG__DETAIL__SYSTEM_POWER__TRAITS_HPP_
#define PX4__MSG__DETAIL__SYSTEM_POWER__TRAITS_HPP_
...
inline std::string to_yaml(const px4::msg::SystemPower & msg)
{
  return px4::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4::msg::SystemPower>()
{
  return "px4::msg::SystemPower";
}

template<>
inline const char * name<px4::msg::SystemPower>()
{
  return "px4/msg/SystemPower";
}

template<>
struct has_fixed_size<px4::msg::SystemPower>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4::msg::SystemPower>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4::msg::SystemPower>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4__MSG__DETAIL__SYSTEM_POWER__TRAITS_HPP_
