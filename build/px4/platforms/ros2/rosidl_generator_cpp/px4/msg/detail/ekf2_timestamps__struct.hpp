...
#ifndef PX4__MSG__DETAIL__EKF2_TIMESTAMPS__STRUCT_HPP_
#define PX4__MSG__DETAIL__EKF2_TIMESTAMPS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__Ekf2Timestamps __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__Ekf2Timestamps __declspec(deprecated)
#endif
...
struct Ekf2Timestamps_
{
  ...
  // pointer types
  using RawPtr =
    px4::msg::Ekf2Timestamps_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::Ekf2Timestamps_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::Ekf2Timestamps_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__Ekf2Timestamps
    std::shared_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__Ekf2Timestamps
    std::shared_ptr<px4::msg::Ekf2Timestamps_<ContainerAllocator> const>
...
using Ekf2Timestamps =
  px4::msg::Ekf2Timestamps_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__EKF2_TIMESTAMPS__STRUCT_HPP_
