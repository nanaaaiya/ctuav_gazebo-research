...
#ifndef PX4__MSG__DETAIL__ARMING_CHECK_REPLY__STRUCT_HPP_
#define PX4__MSG__DETAIL__ARMING_CHECK_REPLY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__ArmingCheckReply __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__ArmingCheckReply __declspec(deprecated)
#endif
...
struct ArmingCheckReply_
{
  ...
  explicit ArmingCheckReply_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->num_events = 0;
      this->events.fill(px4::msg::Event_<ContainerAllocator>{_init});
  ...
  : events(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->can_arm_and_run = false;
      this->num_events = 0;
      this->events.fill(px4::msg::Event_<ContainerAllocator>{_alloc, _init});
      this->mode_req_angular_velocity = false;
      this->mode_req_attitude = false;
      this->mode_req_local_alt = false;
      this->mode_req_local_position = false;
  ...
  using _events_type =
    std::array<px4::msg::Event_<ContainerAllocator>, 5>;
  _events_type events;
  ...
  Type & set__events(
    const std::array<px4::msg::Event_<ContainerAllocator>, 5> & _arg)
  {
    this->events = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    px4::msg::ArmingCheckReply_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::ArmingCheckReply_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::ArmingCheckReply_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__ArmingCheckReply
    std::shared_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__ArmingCheckReply
    std::shared_ptr<px4::msg::ArmingCheckReply_<ContainerAllocator> const>
...
using ArmingCheckReply =
  px4::msg::ArmingCheckReply_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__ARMING_CHECK_REPLY__STRUCT_HPP_
