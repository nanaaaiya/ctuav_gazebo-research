...
#ifndef PX4__MSG__DETAIL__INTERNAL_COMBUSTION_ENGINE_CONTROL__TRAITS_HPP_
#define PX4__MSG__DETAIL__INTERNAL_COMBUSTION_ENGINE_CONTROL__TRAITS_HPP_
...
inline void to_yaml(
  const px4::msg::InternalCombustionEngineControl & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::InternalCombustionEngineControl & msg)
{
  return px4::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4::msg::InternalCombustionEngineControl>()
{
  return "px4::msg::InternalCombustionEngineControl";
}

template<>
inline const char * name<px4::msg::InternalCombustionEngineControl>()
{
  return "px4/msg/InternalCombustionEngineControl";
}

template<>
struct has_fixed_size<px4::msg::InternalCombustionEngineControl>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4::msg::InternalCombustionEngineControl>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4::msg::InternalCombustionEngineControl>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4__MSG__DETAIL__INTERNAL_COMBUSTION_ENGINE_CONTROL__TRAITS_HPP_
