...
static rosidl_typesupport_introspection_c__MessageMember px4__msg__Ekf2Timestamps__rosidl_typesupport_introspection_c__Ekf2Timestamps_message_member_array[8] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__Ekf2Timestamps, airspeed_validated_timestamp_rel),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
