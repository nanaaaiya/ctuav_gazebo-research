...
#ifndef PX4__MSG__DETAIL__SENSOR_OPTICAL_FLOW__STRUCT_H_
#define PX4__MSG__DETAIL__SENSOR_OPTICAL_FLOW__STRUCT_H_
...
enum
{
  px4__msg__SensorOpticalFlow__MODE_UNKNOWN = 0
};

/// Constant 'MODE_BRIGHT'.
enum
{
  px4__msg__SensorOpticalFlow__MODE_BRIGHT = 1
};

/// Constant 'MODE_LOWLIGHT'.
enum
{
  px4__msg__SensorOpticalFlow__MODE_LOWLIGHT = 2
};

/// Constant 'MODE_SUPER_LOWLIGHT'.
enum
{
  px4__msg__SensorOpticalFlow__MODE_SUPER_LOWLIGHT = 3
};

/// Struct defined in msg/SensorOpticalFlow in the package px4.
typedef struct px4__msg__SensorOpticalFlow
{
  ...
  uint8_t mode;
} px4__msg__SensorOpticalFlow;

// Struct for a sequence of px4__msg__SensorOpticalFlow.
typedef struct px4__msg__SensorOpticalFlow__Sequence
{
  px4__msg__SensorOpticalFlow * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__SensorOpticalFlow__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__SENSOR_OPTICAL_FLOW__STRUCT_H_
