...
#ifndef PX4__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_H_
#define PX4__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_H_
...
enum
{
  px4__msg__VehicleCommand__MESSAGE_VERSION = 0ul
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CUSTOM_0 = 0
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CUSTOM_1 = 1
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CUSTOM_2 = 2
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_WAYPOINT = 16
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_LOITER_UNLIM = 17
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_LOITER_TURNS = 18
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_LOITER_TIME = 19
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_RETURN_TO_LAUNCH = 20
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_LAND = 21
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_TAKEOFF = 22
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_PRECLAND = 23
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_ORBIT = 34
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_FIGUREEIGHT = 35
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_ROI = 80
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_PATHPLANNING = 81
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_VTOL_TAKEOFF = 84
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_VTOL_LAND = 85
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_GUIDED_LIMITS = 90
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_GUIDED_MASTER = 91
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_DELAY = 93
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_NAV_LAST = 95
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONDITION_DELAY = 112
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONDITION_CHANGE_ALT = 113
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONDITION_DISTANCE = 114
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONDITION_YAW = 115
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONDITION_LAST = 159
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONDITION_GATE = 4501
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_MODE = 176
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_JUMP = 177
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_CHANGE_SPEED = 178
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_HOME = 179
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_PARAMETER = 180
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_RELAY = 181
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_REPEAT_RELAY = 182
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_REPEAT_SERVO = 184
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_FLIGHTTERMINATION = 185
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_CHANGE_ALTITUDE = 186
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_ACTUATOR = 187
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_LAND_START = 189
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_GO_AROUND = 191
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_REPOSITION = 192
};

/// Constant 'VEHICLE_CMD_DO_PAUSE_CONTINUE'.
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_PAUSE_CONTINUE = 193
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_ROI_LOCATION = 195
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_ROI_WPNEXT_OFFSET = 196
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_ROI_NONE = 197
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_CONTROL_VIDEO = 200
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_ROI = 201
};

/// Constant 'VEHICLE_CMD_DO_DIGICAM_CONTROL'.
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_DIGICAM_CONTROL = 203
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_MOUNT_CONFIGURE = 204
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_MOUNT_CONTROL = 205
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_CAM_TRIGG_DIST = 206
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_FENCE_ENABLE = 207
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_PARACHUTE = 208
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_MOTOR_TEST = 209
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_INVERTED_FLIGHT = 210
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_GRIPPER = 211
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_CAM_TRIGG_INTERVAL = 214
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_MOUNT_CONTROL_QUAT = 220
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_GUIDED_MASTER = 221
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_GUIDED_LIMITS = 222
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_LAST = 240
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PREFLIGHT_CALIBRATION = 241
};
...
enum
{
  px4__msg__VehicleCommand__PREFLIGHT_CALIBRATION_TEMPERATURE_CALIBRATION = 3
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PREFLIGHT_SET_SENSOR_OFFSETS = 242
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PREFLIGHT_UAVCAN = 243
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PREFLIGHT_STORAGE = 245
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PREFLIGHT_REBOOT_SHUTDOWN = 246
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_OBLIQUE_SURVEY = 260
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_STANDARD_MODE = 262
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_GIMBAL_DEVICE_INFORMATION = 283
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_MISSION_START = 300
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_ACTUATOR_TEST = 310
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONFIGURE_ACTUATOR = 311
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_COMPONENT_ARM_DISARM = 400
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_RUN_PREARM_CHECKS = 401
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_INJECT_FAILURE = 420
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_START_RX_PAIR = 500
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_REQUEST_MESSAGE = 512
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_REQUEST_CAMERA_INFORMATION = 521
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_SET_CAMERA_MODE = 530
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_SET_CAMERA_ZOOM = 531
};

/// Constant 'VEHICLE_CMD_SET_CAMERA_FOCUS'.
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_SET_CAMERA_FOCUS = 532
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_GIMBAL_MANAGER_PITCHYAW = 1000
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_GIMBAL_MANAGER_CONFIGURE = 1001
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_IMAGE_START_CAPTURE = 2000
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_TRIGGER_CONTROL = 2003
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_VIDEO_START_CAPTURE = 2500
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_VIDEO_STOP_CAPTURE = 2501
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_LOGGING_START = 2510
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_LOGGING_STOP = 2511
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_CONTROL_HIGH_LATENCY = 2600
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_VTOL_TRANSITION = 3000
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_ARM_AUTHORIZATION_REQUEST = 3001
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PAYLOAD_PREPARE_DEPLOY = 30001
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PAYLOAD_CONTROL_DEPLOY = 30002
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_FIXED_MAG_CAL_YAW = 42006
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_WINCH = 42600
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_EXTERNAL_POSITION_ESTIMATE = 43003
};

/// Constant 'VEHICLE_CMD_EXTERNAL_WIND_ESTIMATE'.
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_EXTERNAL_WIND_ESTIMATE = 43004
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_PX4_INTERNAL_START = 65537ul
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_SET_GPS_GLOBAL_ORIGIN = 100000ul
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_SET_NAV_STATE = 100001ul
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_MOUNT_MODE_RETRACT = 0
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_MOUNT_MODE_NEUTRAL = 1
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_MOUNT_MODE_MAVLINK_TARGETING = 2
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_MOUNT_MODE_RC_TARGETING = 3
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_MOUNT_MODE_GPS_POINT = 4
};

/// Constant 'VEHICLE_MOUNT_MODE_ENUM_END'.
enum
{
  px4__msg__VehicleCommand__VEHICLE_MOUNT_MODE_ENUM_END = 5
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_ROI_NONE = 0
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_ROI_WPNEXT = 1
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_ROI_WPINDEX = 2
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_ROI_LOCATION = 3
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_ROI_TARGET = 4
};

/// Constant 'VEHICLE_ROI_ENUM_END'.
enum
{
  px4__msg__VehicleCommand__VEHICLE_ROI_ENUM_END = 5
};

/// Constant 'PARACHUTE_ACTION_DISABLE'.
enum
{
  px4__msg__VehicleCommand__PARACHUTE_ACTION_DISABLE = 0
};

/// Constant 'PARACHUTE_ACTION_ENABLE'.
enum
{
  px4__msg__VehicleCommand__PARACHUTE_ACTION_ENABLE = 1
};

/// Constant 'PARACHUTE_ACTION_RELEASE'.
enum
{
  px4__msg__VehicleCommand__PARACHUTE_ACTION_RELEASE = 2
};

/// Constant 'FAILURE_UNIT_SENSOR_GYRO'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_GYRO = 0
};

/// Constant 'FAILURE_UNIT_SENSOR_ACCEL'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_ACCEL = 1
};

/// Constant 'FAILURE_UNIT_SENSOR_MAG'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_MAG = 2
};

/// Constant 'FAILURE_UNIT_SENSOR_BARO'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_BARO = 3
};

/// Constant 'FAILURE_UNIT_SENSOR_GPS'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_GPS = 4
};

/// Constant 'FAILURE_UNIT_SENSOR_OPTICAL_FLOW'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_OPTICAL_FLOW = 5
};

/// Constant 'FAILURE_UNIT_SENSOR_VIO'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_VIO = 6
};

/// Constant 'FAILURE_UNIT_SENSOR_DISTANCE_SENSOR'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_DISTANCE_SENSOR = 7
};

/// Constant 'FAILURE_UNIT_SENSOR_AIRSPEED'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SENSOR_AIRSPEED = 8
};

/// Constant 'FAILURE_UNIT_SYSTEM_BATTERY'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SYSTEM_BATTERY = 100
};

/// Constant 'FAILURE_UNIT_SYSTEM_MOTOR'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SYSTEM_MOTOR = 101
};

/// Constant 'FAILURE_UNIT_SYSTEM_SERVO'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SYSTEM_SERVO = 102
};

/// Constant 'FAILURE_UNIT_SYSTEM_AVOIDANCE'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SYSTEM_AVOIDANCE = 103
};

/// Constant 'FAILURE_UNIT_SYSTEM_RC_SIGNAL'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SYSTEM_RC_SIGNAL = 104
};

/// Constant 'FAILURE_UNIT_SYSTEM_MAVLINK_SIGNAL'.
enum
{
  px4__msg__VehicleCommand__FAILURE_UNIT_SYSTEM_MAVLINK_SIGNAL = 105
};

/// Constant 'FAILURE_TYPE_OK'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_OK = 0
};

/// Constant 'FAILURE_TYPE_OFF'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_OFF = 1
};

/// Constant 'FAILURE_TYPE_STUCK'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_STUCK = 2
};

/// Constant 'FAILURE_TYPE_GARBAGE'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_GARBAGE = 3
};

/// Constant 'FAILURE_TYPE_WRONG'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_WRONG = 4
};

/// Constant 'FAILURE_TYPE_SLOW'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_SLOW = 5
};

/// Constant 'FAILURE_TYPE_DELAYED'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_DELAYED = 6
};

/// Constant 'FAILURE_TYPE_INTERMITTENT'.
enum
{
  px4__msg__VehicleCommand__FAILURE_TYPE_INTERMITTENT = 7
};
...
enum
{
  px4__msg__VehicleCommand__SPEED_TYPE_AIRSPEED = 0
};

/// Constant 'SPEED_TYPE_GROUNDSPEED'.
enum
{
  px4__msg__VehicleCommand__SPEED_TYPE_GROUNDSPEED = 1
};

/// Constant 'SPEED_TYPE_CLIMB_SPEED'.
enum
{
  px4__msg__VehicleCommand__SPEED_TYPE_CLIMB_SPEED = 2
};

/// Constant 'SPEED_TYPE_DESCEND_SPEED'.
enum
{
  px4__msg__VehicleCommand__SPEED_TYPE_DESCEND_SPEED = 3
};
...
enum
{
  px4__msg__VehicleCommand__ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TO_CIRCLE_CENTER = 0
};

/// Constant 'ORBIT_YAW_BEHAVIOUR_HOLD_INITIAL_HEADING'.
enum
{
  px4__msg__VehicleCommand__ORBIT_YAW_BEHAVIOUR_HOLD_INITIAL_HEADING = 1
};

/// Constant 'ORBIT_YAW_BEHAVIOUR_UNCONTROLLED'.
enum
{
  px4__msg__VehicleCommand__ORBIT_YAW_BEHAVIOUR_UNCONTROLLED = 2
};

/// Constant 'ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TANGENT_TO_CIRCLE'.
enum
{
  px4__msg__VehicleCommand__ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TANGENT_TO_CIRCLE = 3
};

/// Constant 'ORBIT_YAW_BEHAVIOUR_RC_CONTROLLED'.
enum
{
  px4__msg__VehicleCommand__ORBIT_YAW_BEHAVIOUR_RC_CONTROLLED = 4
};

/// Constant 'ORBIT_YAW_BEHAVIOUR_UNCHANGED'.
enum
{
  px4__msg__VehicleCommand__ORBIT_YAW_BEHAVIOUR_UNCHANGED = 5
};
...
enum
{
  px4__msg__VehicleCommand__ARMING_ACTION_DISARM = 0
};

/// Constant 'ARMING_ACTION_ARM'.
enum
{
  px4__msg__VehicleCommand__ARMING_ACTION_ARM = 1
};
...
enum
{
  px4__msg__VehicleCommand__GRIPPER_ACTION_RELEASE = 0
};

/// Constant 'GRIPPER_ACTION_GRAB'.
enum
{
  px4__msg__VehicleCommand__GRIPPER_ACTION_GRAB = 1
};

/// Constant 'ORB_QUEUE_LENGTH'.
enum
{
  px4__msg__VehicleCommand__ORB_QUEUE_LENGTH = 8
};

/// Constant 'COMPONENT_MODE_EXECUTOR_START'.
enum
{
  px4__msg__VehicleCommand__COMPONENT_MODE_EXECUTOR_START = 1000
};

/// Struct defined in msg/VehicleCommand in the package px4.
/**
 ...
 */
typedef struct px4__msg__VehicleCommand
{
  ...
  bool from_external;
} px4__msg__VehicleCommand;

// Struct for a sequence of px4__msg__VehicleCommand.
typedef struct px4__msg__VehicleCommand__Sequence
{
  px4__msg__VehicleCommand * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__VehicleCommand__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_H_
