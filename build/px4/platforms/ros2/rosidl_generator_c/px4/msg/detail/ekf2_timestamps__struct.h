...
#ifndef PX4__MSG__DETAIL__EKF2_TIMESTAMPS__STRUCT_H_
#define PX4__MSG__DETAIL__EKF2_TIMESTAMPS__STRUCT_H_
...
enum
{
  px4__msg__Ekf2Timestamps__RELATIVE_TIMESTAMP_INVALID = 32767
};

/// Struct defined in msg/Ekf2Timestamps in the package px4.
/**
  * this message contains the (relative) timestamps of the sensor inputs used by EKF2.
  * It can be used for reproducible replay.
 */
typedef struct px4__msg__Ekf2Timestamps
{
...
// Struct for a sequence of px4__msg__Ekf2Timestamps.
typedef struct px4__msg__Ekf2Timestamps__Sequence
{
...
#endif  // PX4__MSG__DETAIL__EKF2_TIMESTAMPS__STRUCT_H_
