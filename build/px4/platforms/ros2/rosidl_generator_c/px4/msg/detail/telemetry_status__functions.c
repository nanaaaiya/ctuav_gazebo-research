...
bool
px4__msg__TelemetryStatus__init(px4__msg__TelemetryStatus * msg)
{
  if (!msg) {
    return false;
  }
...
void
px4__msg__TelemetryStatus__fini(px4__msg__TelemetryStatus * msg)
{
  if (!msg) {
    return;
  }
...
bool
px4__msg__TelemetryStatus__are_equal(const px4__msg__TelemetryStatus * lhs, const px4__msg__TelemetryStatus * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4__msg__TelemetryStatus__copy(
  const px4__msg__TelemetryStatus * input,
  px4__msg__TelemetryStatus * output)
{
  if (!input || !output) {
    return false;
  }
...
px4__msg__TelemetryStatus *
px4__msg__TelemetryStatus__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__TelemetryStatus * msg = (px4__msg__TelemetryStatus *)allocator.allocate(sizeof(px4__msg__TelemetryStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__TelemetryStatus));
  bool success = px4__msg__TelemetryStatus__init(msg);
  if (!success) {
...
void
px4__msg__TelemetryStatus__destroy(px4__msg__TelemetryStatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4__msg__TelemetryStatus__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bool
px4__msg__TelemetryStatus__Sequence__init(px4__msg__TelemetryStatus__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__TelemetryStatus * data = NULL;

  if (size) {
    data = (px4__msg__TelemetryStatus *)allocator.zero_allocate(size, sizeof(px4__msg__TelemetryStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__TelemetryStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__TelemetryStatus__fini(&data[i - 1]);
      }
...
void
px4__msg__TelemetryStatus__Sequence__fini(px4__msg__TelemetryStatus__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__TelemetryStatus__fini(&array->data[i]);
    }
...
px4__msg__TelemetryStatus__Sequence *
px4__msg__TelemetryStatus__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__TelemetryStatus__Sequence * array = (px4__msg__TelemetryStatus__Sequence *)allocator.allocate(sizeof(px4__msg__TelemetryStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__TelemetryStatus__Sequence__init(array, size);
  if (!success) {
...
void
px4__msg__TelemetryStatus__Sequence__destroy(px4__msg__TelemetryStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__TelemetryStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
px4__msg__TelemetryStatus__Sequence__are_equal(const px4__msg__TelemetryStatus__Sequence * lhs, const px4__msg__TelemetryStatus__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__TelemetryStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4__msg__TelemetryStatus__Sequence__copy(
  const px4__msg__TelemetryStatus__Sequence * input,
  px4__msg__TelemetryStatus__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__TelemetryStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    px4__msg__TelemetryStatus * data =
      (px4__msg__TelemetryStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__TelemetryStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4__msg__TelemetryStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4__msg__TelemetryStatus__copy(
