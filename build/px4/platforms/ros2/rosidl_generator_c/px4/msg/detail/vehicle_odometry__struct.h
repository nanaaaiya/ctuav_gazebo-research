...
#ifndef PX4__MSG__DETAIL__VEHICLE_ODOMETRY__STRUCT_H_
#define PX4__MSG__DETAIL__VEHICLE_ODOMETRY__STRUCT_H_
...
enum
{
  px4__msg__VehicleOdometry__MESSAGE_VERSION = 0ul
};

/// Constant 'POSE_FRAME_UNKNOWN'.
enum
{
  px4__msg__VehicleOdometry__POSE_FRAME_UNKNOWN = 0
};
...
enum
{
  px4__msg__VehicleOdometry__POSE_FRAME_NED = 1
};
...
enum
{
  px4__msg__VehicleOdometry__POSE_FRAME_FRD = 2
};

/// Constant 'VELOCITY_FRAME_UNKNOWN'.
enum
{
  px4__msg__VehicleOdometry__VELOCITY_FRAME_UNKNOWN = 0
};
...
enum
{
  px4__msg__VehicleOdometry__VELOCITY_FRAME_NED = 1
};
...
enum
{
  px4__msg__VehicleOdometry__VELOCITY_FRAME_FRD = 2
};
...
enum
{
  px4__msg__VehicleOdometry__VELOCITY_FRAME_BODY_FRD = 3
};

/// Struct defined in msg/VehicleOdometry in the package px4.
/**
  * Vehicle odometry data. Fits ROS REP 147 for aerial vehicles
 */
typedef struct px4__msg__VehicleOdometry
{
  ...
  int8_t quality;
} px4__msg__VehicleOdometry;

// Struct for a sequence of px4__msg__VehicleOdometry.
typedef struct px4__msg__VehicleOdometry__Sequence
{
  px4__msg__VehicleOdometry * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__VehicleOdometry__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__VEHICLE_ODOMETRY__STRUCT_H_
