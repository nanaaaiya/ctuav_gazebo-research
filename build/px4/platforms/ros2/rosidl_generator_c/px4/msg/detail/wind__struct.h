...
#ifndef PX4__MSG__DETAIL__WIND__STRUCT_H_
#define PX4__MSG__DETAIL__WIND__STRUCT_H_
...
enum
{
  px4__msg__Wind__MESSAGE_VERSION = 0ul
};

/// Struct defined in msg/Wind in the package px4.
/**
...
// Struct for a sequence of px4__msg__Wind.
typedef struct px4__msg__Wind__Sequence
{
  px4__msg__Wind * data;
  ...
  size_t capacity;
} px4__msg__Wind__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__WIND__STRUCT_H_
