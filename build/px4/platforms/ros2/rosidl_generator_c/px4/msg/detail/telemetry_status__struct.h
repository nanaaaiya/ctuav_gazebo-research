...
#ifndef PX4__MSG__DETAIL__TELEMETRY_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__TELEMETRY_STATUS__STRUCT_H_
...
enum
{
  px4__msg__TelemetryStatus__LINK_TYPE_GENERIC = 0
};

/// Constant 'LINK_TYPE_UBIQUITY_BULLET'.
enum
{
  px4__msg__TelemetryStatus__LINK_TYPE_UBIQUITY_BULLET = 1
};

/// Constant 'LINK_TYPE_WIRE'.
enum
{
  px4__msg__TelemetryStatus__LINK_TYPE_WIRE = 2
};

/// Constant 'LINK_TYPE_USB'.
enum
{
  px4__msg__TelemetryStatus__LINK_TYPE_USB = 3
};

/// Constant 'LINK_TYPE_IRIDIUM'.
enum
{
  px4__msg__TelemetryStatus__LINK_TYPE_IRIDIUM = 4
};
...
enum
{
  px4__msg__TelemetryStatus__HEARTBEAT_TIMEOUT_US = 2500000ull
};

/// Struct defined in msg/TelemetryStatus in the package px4.
typedef struct px4__msg__TelemetryStatus
{
...
// Struct for a sequence of px4__msg__TelemetryStatus.
typedef struct px4__msg__TelemetryStatus__Sequence
{
...
#endif  // PX4__MSG__DETAIL__TELEMETRY_STATUS__STRUCT_H_
