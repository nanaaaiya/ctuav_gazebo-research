...
#ifndef PX4__MSG__DETAIL__GOTO_SETPOINT__STRUCT_H_
#define PX4__MSG__DETAIL__GOTO_SETPOINT__STRUCT_H_
...
enum
{
  px4__msg__GotoSetpoint__MESSAGE_VERSION = 0ul
};

/// Struct defined in msg/GotoSetpoint in the package px4.
/**
 ...
 */
typedef struct px4__msg__GotoSetpoint
{
...
} px4__msg__GotoSetpoint;

// Struct for a sequence of px4__msg__GotoSetpoint.
typedef struct px4__msg__GotoSetpoint__Sequence
{
  px4__msg__GotoSetpoint * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__GotoSetpoint__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__GOTO_SETPOINT__STRUCT_H_
