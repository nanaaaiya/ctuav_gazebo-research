...
#ifndef PX4__MSG__DETAIL__ESTIMATOR_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__ESTIMATOR_STATUS__STRUCT_H_
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_GPS_FIX = 0
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MIN_SAT_COUNT = 1
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_PDOP = 2
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_HORZ_ERR = 3
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_VERT_ERR = 4
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_SPD_ERR = 5
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_HORZ_DRIFT = 6
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_VERT_DRIFT = 7
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_HORZ_SPD_ERR = 8
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_MAX_VERT_SPD_ERR = 9
};
...
enum
{
  px4__msg__EstimatorStatus__GPS_CHECK_FAIL_SPOOFED = 10
};
...
enum
{
  px4__msg__EstimatorStatus__CS_TILT_ALIGN = 0
};
...
enum
{
  px4__msg__EstimatorStatus__CS_YAW_ALIGN = 1
};

/// Constant 'CS_GNSS_POS'.
/**
  * 2 - true if GNSS position measurements are being fused
 */
enum
{
  px4__msg__EstimatorStatus__CS_GNSS_POS = 2
};
...
enum
{
  px4__msg__EstimatorStatus__CS_OPT_FLOW = 3
};
...
enum
{
  px4__msg__EstimatorStatus__CS_MAG_HDG = 4
};
...
enum
{
  px4__msg__EstimatorStatus__CS_MAG_3D = 5
};
...
enum
{
  px4__msg__EstimatorStatus__CS_MAG_DEC = 6
};
...
enum
{
  px4__msg__EstimatorStatus__CS_IN_AIR = 7
};
...
enum
{
  px4__msg__EstimatorStatus__CS_WIND = 8
};
...
enum
{
  px4__msg__EstimatorStatus__CS_BARO_HGT = 9
};
...
enum
{
  px4__msg__EstimatorStatus__CS_RNG_HGT = 10
};
...
enum
{
  px4__msg__EstimatorStatus__CS_GPS_HGT = 11
};
...
enum
{
  px4__msg__EstimatorStatus__CS_EV_POS = 12
};
...
enum
{
  px4__msg__EstimatorStatus__CS_EV_YAW = 13
};
...
enum
{
  px4__msg__EstimatorStatus__CS_EV_HGT = 14
};
...
enum
{
  px4__msg__EstimatorStatus__CS_BETA = 15
};
...
enum
{
  px4__msg__EstimatorStatus__CS_MAG_FIELD = 16
};
...
enum
{
  px4__msg__EstimatorStatus__CS_FIXED_WING = 17
};
...
enum
{
  px4__msg__EstimatorStatus__CS_MAG_FAULT = 18
};
...
enum
{
  px4__msg__EstimatorStatus__CS_ASPD = 19
};
...
enum
{
  px4__msg__EstimatorStatus__CS_GND_EFFECT = 20
};
...
enum
{
  px4__msg__EstimatorStatus__CS_RNG_STUCK = 21
};
...
enum
{
  px4__msg__EstimatorStatus__CS_GPS_YAW = 22
};
...
enum
{
  px4__msg__EstimatorStatus__CS_MAG_ALIGNED = 23
};
...
enum
{
  px4__msg__EstimatorStatus__CS_EV_VEL = 24
};
...
enum
{
  px4__msg__EstimatorStatus__CS_SYNTHETIC_MAG_Z = 25
};
...
enum
{
  px4__msg__EstimatorStatus__CS_VEHICLE_AT_REST = 26
};
...
enum
{
  px4__msg__EstimatorStatus__CS_GPS_YAW_FAULT = 27
};
...
enum
{
  px4__msg__EstimatorStatus__CS_RNG_FAULT = 28
};

/// Constant 'CS_GNSS_VEL'.
/**
  * 44 - true if GNSS velocity measurements are being fused
 */
enum
{
  px4__msg__EstimatorStatus__CS_GNSS_VEL = 44
};

/// Struct defined in msg/EstimatorStatus in the package px4.
typedef struct px4__msg__EstimatorStatus
{
...
} px4__msg__EstimatorStatus;

// Struct for a sequence of px4__msg__EstimatorStatus.
typedef struct px4__msg__EstimatorStatus__Sequence
{
  px4__msg__EstimatorStatus * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__EstimatorStatus__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__ESTIMATOR_STATUS__STRUCT_H_
