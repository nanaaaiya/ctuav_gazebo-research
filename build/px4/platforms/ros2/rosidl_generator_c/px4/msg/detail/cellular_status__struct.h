...
#ifndef PX4__MSG__DETAIL__CELLULAR_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__CELLULAR_STATUS__STRUCT_H_
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_UNKNOWN = 1
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_FAILED = 2
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_INITIALIZING = 4
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_LOCKED = 8
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_DISABLED = 16
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_DISABLING = 32
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_ENABLING = 64
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_ENABLED = 128
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_SEARCHING = 256
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_REGISTERED = 512
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_DISCONNECTING = 1024
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_CONNECTING = 2048
};
...
enum
{
  px4__msg__CellularStatus__STATUS_FLAG_CONNECTED = 4096
};
...
enum
{
  px4__msg__CellularStatus__FAILURE_REASON_NONE = 0
};
...
enum
{
  px4__msg__CellularStatus__FAILURE_REASON_UNKNOWN = 1
};
...
enum
{
  px4__msg__CellularStatus__FAILURE_REASON_SIM_MISSING = 2
};
...
enum
{
  px4__msg__CellularStatus__FAILURE_REASON_SIM_ERROR = 3
};
...
enum
{
  px4__msg__CellularStatus__CELLULAR_NETWORK_RADIO_TYPE_NONE = 0
};
...
enum
{
  px4__msg__CellularStatus__CELLULAR_NETWORK_RADIO_TYPE_GSM = 1
};
...
enum
{
  px4__msg__CellularStatus__CELLULAR_NETWORK_RADIO_TYPE_CDMA = 2
};
...
enum
{
  px4__msg__CellularStatus__CELLULAR_NETWORK_RADIO_TYPE_WCDMA = 3
};
...
enum
{
  px4__msg__CellularStatus__CELLULAR_NETWORK_RADIO_TYPE_LTE = 4
};

/// Struct defined in msg/CellularStatus in the package px4.
/**
  * Cellular status
  *
  * This is currently used only for logging cell status from MAVLink.
 */
typedef struct px4__msg__CellularStatus
{
  ...
  /// Location area code
  uint16_t lac;
} px4__msg__CellularStatus;

// Struct for a sequence of px4__msg__CellularStatus.
typedef struct px4__msg__CellularStatus__Sequence
{
  px4__msg__CellularStatus * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__CellularStatus__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__CELLULAR_STATUS__STRUCT_H_
