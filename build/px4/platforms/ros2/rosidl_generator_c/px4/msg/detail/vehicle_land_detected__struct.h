...
#ifndef PX4__MSG__DETAIL__VEHICLE_LAND_DETECTED__STRUCT_H_
#define PX4__MSG__DETAIL__VEHICLE_LAND_DETECTED__STRUCT_H_
...
enum
{
  px4__msg__VehicleLandDetected__MESSAGE_VERSION = 0ul
};

/// Struct defined in msg/VehicleLandDetected in the package px4.
typedef struct px4__msg__VehicleLandDetected
{
...
// Struct for a sequence of px4__msg__VehicleLandDetected.
typedef struct px4__msg__VehicleLandDetected__Sequence
{
  px4__msg__VehicleLandDetected * data;
...
#endif  // PX4__MSG__DETAIL__VEHICLE_LAND_DETECTED__STRUCT_H_
