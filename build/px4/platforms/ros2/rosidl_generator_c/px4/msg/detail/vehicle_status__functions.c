...
bool
px4__msg__VehicleStatus__init(px4__msg__VehicleStatus * msg)
{
  if (!msg) {
    return false;
  }
...
void
px4__msg__VehicleStatus__fini(px4__msg__VehicleStatus * msg)
{
  if (!msg) {
    return;
  }
...
bool
px4__msg__VehicleStatus__are_equal(const px4__msg__VehicleStatus * lhs, const px4__msg__VehicleStatus * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4__msg__VehicleStatus__copy(
  const px4__msg__VehicleStatus * input,
  px4__msg__VehicleStatus * output)
{
  if (!input || !output) {
    return false;
  }
...
px4__msg__VehicleStatus__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__VehicleStatus * msg = (px4__msg__VehicleStatus *)allocator.allocate(sizeof(px4__msg__VehicleStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__VehicleStatus));
  bool success = px4__msg__VehicleStatus__init(msg);
  if (!success) {
...
void
px4__msg__VehicleStatus__destroy(px4__msg__VehicleStatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4__msg__VehicleStatus__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bool
px4__msg__VehicleStatus__Sequence__init(px4__msg__VehicleStatus__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__VehicleStatus * data = NULL;

  if (size) {
    data = (px4__msg__VehicleStatus *)allocator.zero_allocate(size, sizeof(px4__msg__VehicleStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__VehicleStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__VehicleStatus__fini(&data[i - 1]);
      }
...
void
px4__msg__VehicleStatus__Sequence__fini(px4__msg__VehicleStatus__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__VehicleStatus__fini(&array->data[i]);
    }
...
px4__msg__VehicleStatus__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__VehicleStatus__Sequence * array = (px4__msg__VehicleStatus__Sequence *)allocator.allocate(sizeof(px4__msg__VehicleStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__VehicleStatus__Sequence__init(array, size);
  if (!success) {
...
void
px4__msg__VehicleStatus__Sequence__destroy(px4__msg__VehicleStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__VehicleStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
px4__msg__VehicleStatus__Sequence__are_equal(const px4__msg__VehicleStatus__Sequence * lhs, const px4__msg__VehicleStatus__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__VehicleStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4__msg__VehicleStatus__Sequence__copy(
  const px4__msg__VehicleStatus__Sequence * input,
  px4__msg__VehicleStatus__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__VehicleStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    px4__msg__VehicleStatus * data =
      (px4__msg__VehicleStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__VehicleStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4__msg__VehicleStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4__msg__VehicleStatus__copy(
