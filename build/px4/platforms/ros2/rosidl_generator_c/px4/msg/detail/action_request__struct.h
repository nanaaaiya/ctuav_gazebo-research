...
#ifndef PX4__MSG__DETAIL__ACTION_REQUEST__STRUCT_H_
#define PX4__MSG__DETAIL__ACTION_REQUEST__STRUCT_H_
...
enum
{
  px4__msg__ActionRequest__ACTION_DISARM = 0
};
...
enum
{
  px4__msg__ActionRequest__ACTION_ARM = 1
};
...
enum
{
  px4__msg__ActionRequest__ACTION_TOGGLE_ARMING = 2
};
...
enum
{
  px4__msg__ActionRequest__ACTION_UNKILL = 3
};
...
enum
{
  px4__msg__ActionRequest__ACTION_KILL = 4
};
...
enum
{
  px4__msg__ActionRequest__ACTION_SWITCH_MODE = 5
};
...
enum
{
  px4__msg__ActionRequest__ACTION_VTOL_TRANSITION_TO_MULTICOPTER = 6
};
...
enum
{
  px4__msg__ActionRequest__ACTION_VTOL_TRANSITION_TO_FIXEDWING = 7
};
...
enum
{
  px4__msg__ActionRequest__ACTION_TERMINATION = 8
};
...
enum
{
  px4__msg__ActionRequest__SOURCE_STICK_GESTURE = 0
};
...
enum
{
  px4__msg__ActionRequest__SOURCE_RC_SWITCH = 1
};
...
enum
{
  px4__msg__ActionRequest__SOURCE_RC_BUTTON = 2
};
...
enum
{
  px4__msg__ActionRequest__SOURCE_RC_MODE_SLOT = 3
};

/// Struct defined in msg/ActionRequest in the package px4.
/**
 ...
 */
typedef struct px4__msg__ActionRequest
{
...
// Struct for a sequence of px4__msg__ActionRequest.
typedef struct px4__msg__ActionRequest__Sequence
{
  px4__msg__ActionRequest * data;
...
#endif  // PX4__MSG__DETAIL__ACTION_REQUEST__STRUCT_H_
