...
#ifndef PX4__MSG__DETAIL__REGISTER_EXT_COMPONENT_REQUEST__STRUCT_H_
#define PX4__MSG__DETAIL__REGISTER_EXT_COMPONENT_REQUEST__STRUCT_H_
...
enum
{
  px4__msg__RegisterExtComponentRequest__MESSAGE_VERSION = 0ul
};
...
enum
{
  px4__msg__RegisterExtComponentRequest__LATEST_PX4_ROS2_API_VERSION = 1
};

/// Constant 'ORB_QUEUE_LENGTH'.
enum
{
  px4__msg__RegisterExtComponentRequest__ORB_QUEUE_LENGTH = 2
};

/// Struct defined in msg/RegisterExtComponentRequest in the package px4.
/**
  * Request to register an external component
 */
typedef struct px4__msg__RegisterExtComponentRequest
{
...
// Struct for a sequence of px4__msg__RegisterExtComponentRequest.
typedef struct px4__msg__RegisterExtComponentRequest__Sequence
{
  px4__msg__RegisterExtComponentRequest * data;
...
#endif  // PX4__MSG__DETAIL__REGISTER_EXT_COMPONENT_REQUEST__STRUCT_H_
