...
#ifndef PX4__MSG__DETAIL__VEHICLE_LOCAL_POSITION__STRUCT_H_
#define PX4__MSG__DETAIL__VEHICLE_LOCAL_POSITION__STRUCT_H_
...
enum
{
  px4__msg__VehicleLocalPosition__MESSAGE_VERSION = 1ul
};

/// Constant 'DIST_BOTTOM_SENSOR_NONE'.
enum
{
  px4__msg__VehicleLocalPosition__DIST_BOTTOM_SENSOR_NONE = 0
};
...
enum
{
  px4__msg__VehicleLocalPosition__DIST_BOTTOM_SENSOR_RANGE = 1
};
...
enum
{
  px4__msg__VehicleLocalPosition__DIST_BOTTOM_SENSOR_FLOW = 2
};

/// Struct defined in msg/VehicleLocalPosition in the package px4.
/**
  * Fused local position in NED.
  * The coordinate system origin is the vehicle position at the time when the EKF2-module was started.
 */
typedef struct px4__msg__VehicleLocalPosition
{
...
// Struct for a sequence of px4__msg__VehicleLocalPosition.
typedef struct px4__msg__VehicleLocalPosition__Sequence
{
...
#endif  // PX4__MSG__DETAIL__VEHICLE_LOCAL_POSITION__STRUCT_H_
