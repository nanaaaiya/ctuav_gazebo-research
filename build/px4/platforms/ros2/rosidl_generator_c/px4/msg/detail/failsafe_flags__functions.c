...
bool
px4__msg__FailsafeFlags__init(px4__msg__FailsafeFlags * msg)
{
  if (!msg) {
    return false;
  }
...
void
px4__msg__FailsafeFlags__fini(px4__msg__FailsafeFlags * msg)
{
  if (!msg) {
    return;
  }
...
bool
px4__msg__FailsafeFlags__are_equal(const px4__msg__FailsafeFlags * lhs, const px4__msg__FailsafeFlags * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4__msg__FailsafeFlags__copy(
  const px4__msg__FailsafeFlags * input,
  px4__msg__FailsafeFlags * output)
{
  if (!input || !output) {
    return false;
  }
...
px4__msg__FailsafeFlags *
px4__msg__FailsafeFlags__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__FailsafeFlags * msg = (px4__msg__FailsafeFlags *)allocator.allocate(sizeof(px4__msg__FailsafeFlags), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__FailsafeFlags));
  bool success = px4__msg__FailsafeFlags__init(msg);
  if (!success) {
...
void
px4__msg__FailsafeFlags__destroy(px4__msg__FailsafeFlags * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4__msg__FailsafeFlags__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bool
px4__msg__FailsafeFlags__Sequence__init(px4__msg__FailsafeFlags__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__FailsafeFlags * data = NULL;

  if (size) {
    data = (px4__msg__FailsafeFlags *)allocator.zero_allocate(size, sizeof(px4__msg__FailsafeFlags), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__FailsafeFlags__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__FailsafeFlags__fini(&data[i - 1]);
      }
...
void
px4__msg__FailsafeFlags__Sequence__fini(px4__msg__FailsafeFlags__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__FailsafeFlags__fini(&array->data[i]);
    }
...
px4__msg__FailsafeFlags__Sequence *
px4__msg__FailsafeFlags__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__FailsafeFlags__Sequence * array = (px4__msg__FailsafeFlags__Sequence *)allocator.allocate(sizeof(px4__msg__FailsafeFlags__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__FailsafeFlags__Sequence__init(array, size);
  if (!success) {
...
void
px4__msg__FailsafeFlags__Sequence__destroy(px4__msg__FailsafeFlags__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__FailsafeFlags__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
px4__msg__FailsafeFlags__Sequence__are_equal(const px4__msg__FailsafeFlags__Sequence * lhs, const px4__msg__FailsafeFlags__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__FailsafeFlags__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4__msg__FailsafeFlags__Sequence__copy(
  const px4__msg__FailsafeFlags__Sequence * input,
  px4__msg__FailsafeFlags__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__FailsafeFlags);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    px4__msg__FailsafeFlags * data =
      (px4__msg__FailsafeFlags *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__FailsafeFlags__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4__msg__FailsafeFlags__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4__msg__FailsafeFlags__copy(
