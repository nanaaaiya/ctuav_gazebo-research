...
#ifndef PX4__MSG__DETAIL__MANUAL_CONTROL_SWITCHES__STRUCT_H_
#define PX4__MSG__DETAIL__MANUAL_CONTROL_SWITCHES__STRUCT_H_
...
enum
{
  px4__msg__ManualControlSwitches__SWITCH_POS_NONE = 0
};
...
enum
{
  px4__msg__ManualControlSwitches__SWITCH_POS_ON = 1
};
...
enum
{
  px4__msg__ManualControlSwitches__SWITCH_POS_MIDDLE = 2
};
...
enum
{
  px4__msg__ManualControlSwitches__SWITCH_POS_OFF = 3
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_NONE = 0
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_1 = 1
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_2 = 2
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_3 = 3
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_4 = 4
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_5 = 5
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_6 = 6
};
...
enum
{
  px4__msg__ManualControlSwitches__MODE_SLOT_NUM = 6
};

/// Struct defined in msg/ManualControlSwitches in the package px4.
typedef struct px4__msg__ManualControlSwitches
{
...
// Struct for a sequence of px4__msg__ManualControlSwitches.
typedef struct px4__msg__ManualControlSwitches__Sequence
{
...
#endif  // PX4__MSG__DETAIL__MANUAL_CONTROL_SWITCHES__STRUCT_H_
