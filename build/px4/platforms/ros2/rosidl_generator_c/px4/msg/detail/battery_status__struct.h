...
#ifndef PX4__MSG__DETAIL__BATTERY_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__BATTERY_STATUS__STRUCT_H_
...
enum
{
  px4__msg__BatteryStatus__MESSAGE_VERSION = 1ul
};

/// Constant 'MAX_INSTANCES'.
enum
{
  px4__msg__BatteryStatus__MAX_INSTANCES = 4
};
...
enum
{
  px4__msg__BatteryStatus__SOURCE_POWER_MODULE = 0
};
...
enum
{
  px4__msg__BatteryStatus__SOURCE_EXTERNAL = 1
};
...
enum
{
  px4__msg__BatteryStatus__SOURCE_ESCS = 2
};
...
enum
{
  px4__msg__BatteryStatus__WARNING_NONE = 0
};
...
enum
{
  px4__msg__BatteryStatus__WARNING_LOW = 1
};
...
enum
{
  px4__msg__BatteryStatus__WARNING_CRITICAL = 2
};
...
enum
{
  px4__msg__BatteryStatus__WARNING_EMERGENCY = 3
};
...
enum
{
  px4__msg__BatteryStatus__WARNING_FAILED = 4
};
...
enum
{
  px4__msg__BatteryStatus__STATE_UNHEALTHY = 6
};
...
enum
{
  px4__msg__BatteryStatus__STATE_CHARGING = 7
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_DEEP_DISCHARGE = 0
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_SPIKES = 1
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_CELL_FAIL = 2
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_OVER_CURRENT = 3
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_OVER_TEMPERATURE = 4
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_UNDER_TEMPERATURE = 5
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_INCOMPATIBLE_VOLTAGE = 6
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_INCOMPATIBLE_FIRMWARE = 7
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_INCOMPATIBLE_MODEL = 8
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_HARDWARE_FAILURE = 9
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_FAILED_TO_ARM = 10
};
...
enum
{
  px4__msg__BatteryStatus__FAULT_COUNT = 11
};

/// Struct defined in msg/BatteryStatus in the package px4.
/**
  * Battery status
  *
 ...
 */
typedef struct px4__msg__BatteryStatus
{
...
// Struct for a sequence of px4__msg__BatteryStatus.
typedef struct px4__msg__BatteryStatus__Sequence
{
...
#endif  // PX4__MSG__DETAIL__BATTERY_STATUS__STRUCT_H_
