...
#ifndef PX4__MSG__DETAIL__LONGITUDINAL_CONTROL_CONFIGURATION__STRUCT_H_
#define PX4__MSG__DETAIL__LONGITUDINAL_CONTROL_CONFIGURATION__STRUCT_H_
...
enum
{
  px4__msg__LongitudinalControlConfiguration__MESSAGE_VERSION = 0ul
};

/// Struct defined in msg/LongitudinalControlConfiguration in the package px4.
/**
 ...
 */
typedef struct px4__msg__LongitudinalControlConfiguration
{
...
// Struct for a sequence of px4__msg__LongitudinalControlConfiguration.
typedef struct px4__msg__LongitudinalControlConfiguration__Sequence
{
...
#endif  // PX4__MSG__DETAIL__LONGITUDINAL_CONTROL_CONFIGURATION__STRUCT_H_
