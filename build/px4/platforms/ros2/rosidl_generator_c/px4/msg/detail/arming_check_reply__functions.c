...
bool
px4__msg__ArmingCheckReply__init(px4__msg__ArmingCheckReply * msg)
{
  if (!msg) {
    return false;
  }
  ...
  for (size_t i = 0; i < 5; ++i) {
    if (!px4__msg__Event__init(&msg->events[i])) {
      px4__msg__ArmingCheckReply__fini(msg);
      return false;
    }
  }
...
void
px4__msg__ArmingCheckReply__fini(px4__msg__ArmingCheckReply * msg)
{
  if (!msg) {
    return;
  }
  ...
  // events
  for (size_t i = 0; i < 5; ++i) {
    px4__msg__Event__fini(&msg->events[i]);
  }
  // mode_req_angular_velocity
  // mode_req_attitude
  // mode_req_local_alt
...
bool
px4__msg__ArmingCheckReply__are_equal(const px4__msg__ArmingCheckReply * lhs, const px4__msg__ArmingCheckReply * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4__msg__ArmingCheckReply__copy(
  const px4__msg__ArmingCheckReply * input,
  px4__msg__ArmingCheckReply * output)
{
  if (!input || !output) {
    return false;
  }
...
px4__msg__ArmingCheckReply__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__ArmingCheckReply * msg = (px4__msg__ArmingCheckReply *)allocator.allocate(sizeof(px4__msg__ArmingCheckReply), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__ArmingCheckReply));
  bool success = px4__msg__ArmingCheckReply__init(msg);
  if (!success) {
...
void
px4__msg__ArmingCheckReply__destroy(px4__msg__ArmingCheckReply * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4__msg__ArmingCheckReply__fini(msg);
...
bool
px4__msg__ArmingCheckReply__Sequence__init(px4__msg__ArmingCheckReply__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__ArmingCheckReply * data = NULL;

  if (size) {
    data = (px4__msg__ArmingCheckReply *)allocator.zero_allocate(size, sizeof(px4__msg__ArmingCheckReply), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__ArmingCheckReply__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__ArmingCheckReply__fini(&data[i - 1]);
      }
...
void
px4__msg__ArmingCheckReply__Sequence__fini(px4__msg__ArmingCheckReply__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__ArmingCheckReply__fini(&array->data[i]);
    }
...
px4__msg__ArmingCheckReply__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__ArmingCheckReply__Sequence * array = (px4__msg__ArmingCheckReply__Sequence *)allocator.allocate(sizeof(px4__msg__ArmingCheckReply__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__ArmingCheckReply__Sequence__init(array, size);
  if (!success) {
...
void
px4__msg__ArmingCheckReply__Sequence__destroy(px4__msg__ArmingCheckReply__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__ArmingCheckReply__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
px4__msg__ArmingCheckReply__Sequence__are_equal(const px4__msg__ArmingCheckReply__Sequence * lhs, const px4__msg__ArmingCheckReply__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__ArmingCheckReply__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4__msg__ArmingCheckReply__Sequence__copy(
  const px4__msg__ArmingCheckReply__Sequence * input,
  px4__msg__ArmingCheckReply__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__ArmingCheckReply);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    px4__msg__ArmingCheckReply * data =
      (px4__msg__ArmingCheckReply *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__ArmingCheckReply__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4__msg__ArmingCheckReply__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4__msg__ArmingCheckReply__copy(
