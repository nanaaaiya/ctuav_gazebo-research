...
#ifndef PX4__MSG__DETAIL__VEHICLE_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__VEHICLE_STATUS__STRUCT_H_
...
enum
{
  px4__msg__VehicleStatus__MESSAGE_VERSION = 1ul
};

/// Constant 'ARMING_STATE_DISARMED'.
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_DISARMED = 1
};

/// Constant 'ARMING_STATE_ARMED'.
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_ARMED = 2
};

/// Constant 'ARM_DISARM_REASON_TRANSITION_TO_STANDBY'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_TRANSITION_TO_STANDBY = 0
};

/// Constant 'ARM_DISARM_REASON_STICK_GESTURE'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_STICK_GESTURE = 1
};

/// Constant 'ARM_DISARM_REASON_RC_SWITCH'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_RC_SWITCH = 2
};

/// Constant 'ARM_DISARM_REASON_COMMAND_INTERNAL'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_COMMAND_INTERNAL = 3
};

/// Constant 'ARM_DISARM_REASON_COMMAND_EXTERNAL'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_COMMAND_EXTERNAL = 4
};

/// Constant 'ARM_DISARM_REASON_MISSION_START'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_MISSION_START = 5
};

/// Constant 'ARM_DISARM_REASON_SAFETY_BUTTON'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_SAFETY_BUTTON = 6
};

/// Constant 'ARM_DISARM_REASON_AUTO_DISARM_LAND'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_AUTO_DISARM_LAND = 7
};

/// Constant 'ARM_DISARM_REASON_AUTO_DISARM_PREFLIGHT'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_AUTO_DISARM_PREFLIGHT = 8
};

/// Constant 'ARM_DISARM_REASON_KILL_SWITCH'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_KILL_SWITCH = 9
};

/// Constant 'ARM_DISARM_REASON_LOCKDOWN'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_LOCKDOWN = 10
};

/// Constant 'ARM_DISARM_REASON_FAILURE_DETECTOR'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_FAILURE_DETECTOR = 11
};

/// Constant 'ARM_DISARM_REASON_SHUTDOWN'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_SHUTDOWN = 12
};

/// Constant 'ARM_DISARM_REASON_UNIT_TEST'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_UNIT_TEST = 13
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_MANUAL = 0
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_ALTCTL = 1
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_POSCTL = 2
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_MISSION = 3
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_LOITER = 4
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_RTL = 5
};

/// Constant 'NAVIGATION_STATE_POSITION_SLOW'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_POSITION_SLOW = 6
};

/// Constant 'NAVIGATION_STATE_FREE5'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_FREE5 = 7
};

/// Constant 'NAVIGATION_STATE_FREE4'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_FREE4 = 8
};

/// Constant 'NAVIGATION_STATE_FREE3'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_FREE3 = 9
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_ACRO = 10
};

/// Constant 'NAVIGATION_STATE_FREE2'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_FREE2 = 11
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_DESCEND = 12
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_TERMINATION = 13
};

/// Constant 'NAVIGATION_STATE_OFFBOARD'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_OFFBOARD = 14
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_STAB = 15
};

/// Constant 'NAVIGATION_STATE_FREE1'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_FREE1 = 16
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_TAKEOFF = 17
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_LAND = 18
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_FOLLOW_TARGET = 19
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_PRECLAND = 20
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_ORBIT = 21
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_AUTO_VTOL_TAKEOFF = 22
};

/// Constant 'NAVIGATION_STATE_EXTERNAL1'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL1 = 23
};

/// Constant 'NAVIGATION_STATE_EXTERNAL2'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL2 = 24
};

/// Constant 'NAVIGATION_STATE_EXTERNAL3'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL3 = 25
};

/// Constant 'NAVIGATION_STATE_EXTERNAL4'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL4 = 26
};

/// Constant 'NAVIGATION_STATE_EXTERNAL5'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL5 = 27
};

/// Constant 'NAVIGATION_STATE_EXTERNAL6'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL6 = 28
};

/// Constant 'NAVIGATION_STATE_EXTERNAL7'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL7 = 29
};

/// Constant 'NAVIGATION_STATE_EXTERNAL8'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_EXTERNAL8 = 30
};

/// Constant 'NAVIGATION_STATE_MAX'.
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_MAX = 31
};

/// Constant 'FAILURE_NONE'.
enum
{
  px4__msg__VehicleStatus__FAILURE_NONE = 0
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_ROLL = 1
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_PITCH = 2
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_ALT = 4
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_EXT = 8
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_ARM_ESC = 16
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_BATTERY = 32
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_IMBALANCED_PROP = 64
};
...
enum
{
  px4__msg__VehicleStatus__FAILURE_MOTOR = 128
};

/// Constant 'HIL_STATE_OFF'.
enum
{
  px4__msg__VehicleStatus__HIL_STATE_OFF = 0
};

/// Constant 'HIL_STATE_ON'.
enum
{
  px4__msg__VehicleStatus__HIL_STATE_ON = 1
};

/// Constant 'VEHICLE_TYPE_UNSPECIFIED'.
enum
{
  px4__msg__VehicleStatus__VEHICLE_TYPE_UNSPECIFIED = 0
};

/// Constant 'VEHICLE_TYPE_ROTARY_WING'.
enum
{
  px4__msg__VehicleStatus__VEHICLE_TYPE_ROTARY_WING = 1
};

/// Constant 'VEHICLE_TYPE_FIXED_WING'.
enum
{
  px4__msg__VehicleStatus__VEHICLE_TYPE_FIXED_WING = 2
};

/// Constant 'VEHICLE_TYPE_ROVER'.
enum
{
  px4__msg__VehicleStatus__VEHICLE_TYPE_ROVER = 3
};

/// Constant 'FAILSAFE_DEFER_STATE_DISABLED'.
enum
{
  px4__msg__VehicleStatus__FAILSAFE_DEFER_STATE_DISABLED = 0
};

/// Constant 'FAILSAFE_DEFER_STATE_ENABLED'.
enum
{
  px4__msg__VehicleStatus__FAILSAFE_DEFER_STATE_ENABLED = 1
};
...
enum
{
  px4__msg__VehicleStatus__FAILSAFE_DEFER_STATE_WOULD_FAILSAFE = 2
};

/// Struct defined in msg/VehicleStatus in the package px4.
/**
  * Encodes the system state of the vehicle published by commander
 */
typedef struct px4__msg__VehicleStatus
{
...
} px4__msg__VehicleStatus;

// Struct for a sequence of px4__msg__VehicleStatus.
typedef struct px4__msg__VehicleStatus__Sequence
{
  px4__msg__VehicleStatus * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__VehicleStatus__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__VEHICLE_STATUS__STRUCT_H_
