...
px4__msg__FixedWingLongitudinalSetpoint__create()
{
  ...
  px4__msg__FixedWingLongitudinalSetpoint * msg = (px4__msg__FixedWingLongitudinalSetpoint *)allocator.allocate(sizeof(px4__msg__FixedWingLongitudinalSetpoint), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__FixedWingLongitudinalSetpoint));
  bool success = px4__msg__FixedWingLongitudinalSetpoint__init(msg);
  if (!success) {
...
px4__msg__FixedWingLongitudinalSetpoint__destroy(px4__msg__FixedWingLongitudinalSetpoint * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4__msg__FixedWingLongitudinalSetpoint__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
px4__msg__FixedWingLongitudinalSetpoint__Sequence__init(px4__msg__FixedWingLongitudinalSetpoint__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__FixedWingLongitudinalSetpoint * data = NULL;

  if (size) {
    data = (px4__msg__FixedWingLongitudinalSetpoint *)allocator.zero_allocate(size, sizeof(px4__msg__FixedWingLongitudinalSetpoint), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__FixedWingLongitudinalSetpoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__FixedWingLongitudinalSetpoint__fini(&data[i - 1]);
      }
...
px4__msg__FixedWingLongitudinalSetpoint__Sequence__fini(px4__msg__FixedWingLongitudinalSetpoint__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__FixedWingLongitudinalSetpoint__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__FixedWingLongitudinalSetpoint__Sequence * array = (px4__msg__FixedWingLongitudinalSetpoint__Sequence *)allocator.allocate(sizeof(px4__msg__FixedWingLongitudinalSetpoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__FixedWingLongitudinalSetpoint__Sequence__init(array, size);
  if (!success) {
...
px4__msg__FixedWingLongitudinalSetpoint__Sequence__destroy(px4__msg__FixedWingLongitudinalSetpoint__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__FixedWingLongitudinalSetpoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
px4__msg__FixedWingLongitudinalSetpoint__Sequence__are_equal(const px4__msg__FixedWingLongitudinalSetpoint__Sequence * lhs, const px4__msg__FixedWingLongitudinalSetpoint__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__FixedWingLongitudinalSetpoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4__msg__FixedWingLongitudinalSetpoint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__FixedWingLongitudinalSetpoint);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    px4__msg__FixedWingLongitudinalSetpoint * data =
      (px4__msg__FixedWingLongitudinalSetpoint *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__FixedWingLongitudinalSetpoint__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4__msg__FixedWingLongitudinalSetpoint__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4__msg__FixedWingLongitudinalSetpoint__copy(
