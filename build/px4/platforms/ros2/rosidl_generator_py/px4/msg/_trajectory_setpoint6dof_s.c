...
bool px4__msg__trajectory_setpoint6dof__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._trajectory_setpoint6dof.TrajectorySetpoint6dof", full_classname_dest, 55) == 0);
  }
  px4__msg__TrajectorySetpoint6dof * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // acceleration
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT32);
      Py_ssize_t size = 3;
      float * dest = ros_message->acceleration;
      for (Py_ssize_t i = 0; i < size; ++i) {
        float tmp = *(npy_float32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(float));
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__trajectory_setpoint6dof__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of TrajectorySetpoint6dof */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._trajectory_setpoint6dof");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectorySetpoint6dof");
  ...
  px4__msg__TrajectorySetpoint6dof * ros_message = (px4__msg__TrajectorySetpoint6dof *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // acceleration
    ...
    assert(sizeof(npy_float32) == sizeof(float));
    npy_float32 * dst = (npy_float32 *)PyArray_GETPTR1(seq_field, 0);
    float * src = &(ros_message->acceleration[0]);
    memcpy(dst, src, 3 * sizeof(float));
    Py_DECREF(field);
  }
  {  // jerk
