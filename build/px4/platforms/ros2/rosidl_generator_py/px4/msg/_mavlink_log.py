...
class Metaclass_MavlinkLog(type):
    """Metaclass of message 'MavlinkLog'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mavlink_log
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mavlink_log
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mavlink_log
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mavlink_log
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mavlink_log
    ...
    def ORB_QUEUE_LENGTH(self):
        ...
        return Metaclass_MavlinkLog.__constants['ORB_QUEUE_LENGTH']


class MavlinkLog(metaclass=Metaclass_MavlinkLog):
    """
