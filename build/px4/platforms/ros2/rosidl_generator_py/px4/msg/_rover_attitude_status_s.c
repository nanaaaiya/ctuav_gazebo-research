...
bool px4__msg__rover_attitude_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._rover_attitude_status.RoverAttitudeStatus", full_classname_dest, 50) == 0);
  }
  px4__msg__RoverAttitudeStatus * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__rover_attitude_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RoverAttitudeStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._rover_attitude_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoverAttitudeStatus");
  ...
  px4__msg__RoverAttitudeStatus * ros_message = (px4__msg__RoverAttitudeStatus *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
