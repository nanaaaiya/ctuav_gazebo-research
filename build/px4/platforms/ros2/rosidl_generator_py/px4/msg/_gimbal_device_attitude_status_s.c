...
bool px4__msg__gimbal_device_attitude_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._gimbal_device_attitude_status.GimbalDeviceAttitudeStatus", full_classname_dest, 65) == 0);
  }
  px4__msg__GimbalDeviceAttitudeStatus * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__gimbal_device_attitude_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GimbalDeviceAttitudeStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._gimbal_device_attitude_status");
  ...
  px4__msg__GimbalDeviceAttitudeStatus * ros_message = (px4__msg__GimbalDeviceAttitudeStatus *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
