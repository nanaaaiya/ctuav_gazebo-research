...
bool px4__msg__airspeed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._airspeed.Airspeed", full_classname_dest, 26) == 0);
  }
  px4__msg__Airspeed * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__airspeed__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Airspeed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._airspeed");
  ...
  px4__msg__Airspeed * ros_message = (px4__msg__Airspeed *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
