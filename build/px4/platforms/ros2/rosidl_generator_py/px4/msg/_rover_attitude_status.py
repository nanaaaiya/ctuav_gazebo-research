...
class Metaclass_RoverAttitudeStatus(type):
    """Metaclass of message 'RoverAttitudeStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.RoverAttitudeStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rover_attitude_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rover_attitude_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rover_attitude_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rover_attitude_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rover_attitude_status
...
class RoverAttitudeStatus(metaclass=Metaclass_RoverAttitudeStatus):
    """Message class 'RoverAttitudeStatus'."""
