...
class Metaclass_RegisterExtComponentReply(type):
    """Metaclass of message 'RegisterExtComponentReply'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.RegisterExtComponentReply')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__register_ext_component_reply
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__register_ext_component_reply
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__register_ext_component_reply
            cls._TYPE_SUPPORT = module.type_support_msg__msg__register_ext_component_reply
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__register_ext_component_reply
    ...
    def ORB_QUEUE_LENGTH(self):
        ...
        return Metaclass_RegisterExtComponentReply.__constants['ORB_QUEUE_LENGTH']


class RegisterExtComponentReply(metaclass=Metaclass_RegisterExtComponentReply):
    """
