...
bool px4__msg__event__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * px4__msg__event__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool px4__msg__arming_check_reply__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._arming_check_reply.ArmingCheckReply", full_classname_dest, 44) == 0);
  }
  px4__msg__ArmingCheckReply * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // events
    ...
    Py_ssize_t size = 5;
    px4__msg__Event * dest = ros_message->events;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!px4__msg__event__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__arming_check_reply__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ArmingCheckReply */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._arming_check_reply");
  ...
  px4__msg__ArmingCheckReply * ros_message = (px4__msg__ArmingCheckReply *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // events
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = px4__msg__event__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
