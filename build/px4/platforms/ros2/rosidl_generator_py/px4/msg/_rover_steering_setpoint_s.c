...
bool px4__msg__rover_steering_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._rover_steering_setpoint.RoverSteeringSetpoint", full_classname_dest, 54) == 0);
  }
  px4__msg__RoverSteeringSetpoint * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__rover_steering_setpoint__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RoverSteeringSetpoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._rover_steering_setpoint");
  ...
  px4__msg__RoverSteeringSetpoint * ros_message = (px4__msg__RoverSteeringSetpoint *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
