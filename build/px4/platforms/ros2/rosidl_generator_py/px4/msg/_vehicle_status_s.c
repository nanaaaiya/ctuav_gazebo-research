...
bool px4__msg__vehicle_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._vehicle_status.VehicleStatus", full_classname_dest, 37) == 0);
  }
  px4__msg__VehicleStatus * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__vehicle_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VehicleStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._vehicle_status");
  ...
  px4__msg__VehicleStatus * ros_message = (px4__msg__VehicleStatus *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
