...
bool px4__msg__satellite_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._satellite_info.SatelliteInfo", full_classname_dest, 37) == 0);
  }
  px4__msg__SatelliteInfo * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__satellite_info__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of SatelliteInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._satellite_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SatelliteInfo");
  ...
  px4__msg__SatelliteInfo * ros_message = (px4__msg__SatelliteInfo *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // svid
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "svid");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
  ...
  {  // used
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "used");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
  ...
  {  // elevation
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "elevation");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
  ...
  {  // azimuth
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "azimuth");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
  ...
  {  // snr
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "snr");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
  ...
  {  // prn
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "prn");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
