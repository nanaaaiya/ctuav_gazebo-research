...
bool px4__msg__rc_channels__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._rc_channels.RcChannels", full_classname_dest, 31) == 0);
  }
  px4__msg__RcChannels * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__rc_channels__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RcChannels */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._rc_channels");
  ...
  px4__msg__RcChannels * ros_message = (px4__msg__RcChannels *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // function
    ...
    memcpy(dst, src, 30 * sizeof(int8_t));
    Py_DECREF(field);
  }
  {  // rssi
    PyObject * field = NULL;
