...
bool px4__msg__dronecan_node_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._dronecan_node_status.DronecanNodeStatus", full_classname_dest, 48) == 0);
  }
  px4__msg__DronecanNodeStatus * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__dronecan_node_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of DronecanNodeStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._dronecan_node_status");
  ...
  px4__msg__DronecanNodeStatus * ros_message = (px4__msg__DronecanNodeStatus *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
