...
class Metaclass_FixedWingLateralStatus(type):
    """Metaclass of message 'FixedWingLateralStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.FixedWingLateralStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__fixed_wing_lateral_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__fixed_wing_lateral_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__fixed_wing_lateral_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__fixed_wing_lateral_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__fixed_wing_lateral_status
...
class FixedWingLateralStatus(metaclass=Metaclass_FixedWingLateralStatus):
    """Message class 'FixedWingLateralStatus'."""
