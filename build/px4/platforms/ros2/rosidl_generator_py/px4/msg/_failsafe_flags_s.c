...
bool px4__msg__failsafe_flags__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._failsafe_flags.FailsafeFlags", full_classname_dest, 37) == 0);
  }
  px4__msg__FailsafeFlags * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__failsafe_flags__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FailsafeFlags */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._failsafe_flags");
  ...
  px4__msg__FailsafeFlags * ros_message = (px4__msg__FailsafeFlags *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
