...
bool px4__msg__vehicle_local_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._vehicle_local_position.VehicleLocalPosition", full_classname_dest, 52) == 0);
  }
  px4__msg__VehicleLocalPosition * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__vehicle_local_position__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VehicleLocalPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._vehicle_local_position");
  ...
  px4__msg__VehicleLocalPosition * ros_message = (px4__msg__VehicleLocalPosition *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
