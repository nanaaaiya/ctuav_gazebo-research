...
class Metaclass_SensorOpticalFlow(type):
    """Metaclass of message 'SensorOpticalFlow'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.SensorOpticalFlow')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sensor_optical_flow
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sensor_optical_flow
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sensor_optical_flow
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sensor_optical_flow
    ...
    def MODE_UNKNOWN(self):
        ...
        return Metaclass_SensorOpticalFlow.__constants['MODE_UNKNOWN']

    @property
    def MODE_BRIGHT(self):
        """Message constant 'MODE_BRIGHT'."""
        return Metaclass_SensorOpticalFlow.__constants['MODE_BRIGHT']

    @property
    def MODE_LOWLIGHT(self):
        """Message constant 'MODE_LOWLIGHT'."""
        return Metaclass_SensorOpticalFlow.__constants['MODE_LOWLIGHT']

    @property
    def MODE_SUPER_LOWLIGHT(self):
        """Message constant 'MODE_SUPER_LOWLIGHT'."""
        return Metaclass_SensorOpticalFlow.__constants['MODE_SUPER_LOWLIGHT']


class SensorOpticalFlow(metaclass=Metaclass_SensorOpticalFlow):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.delta_angle_available = kwargs.get('delta_angle_available', bool())
        self.distance_m = kwargs.get('distance_m', float())
        self.distance_available = kwargs.get('distance_available', bool())
    ...
    def __eq__(self, other):
        ...
        if self.distance_m != other.distance_m:
            return False
        if self.distance_available != other.distance_available:
            return False
    ...
    @builtins.property
    def delta_angle_available(self):
        """Message field 'delta_angle_available'."""
        return self._delta_angle_available
    ...
    def delta_angle_available(self, value):
        ...
        self._delta_angle_available = value
    ...
    def distance_available(self):
        """Message field 'distance_available'."""
        return self._distance_available
    ...
    def distance_available(self, value):
        ...
        self._distance_available = value
