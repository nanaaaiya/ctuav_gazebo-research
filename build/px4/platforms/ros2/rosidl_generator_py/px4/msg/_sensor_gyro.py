...
class Metaclass_SensorGyro(type):
    """Metaclass of message 'SensorGyro'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sensor_gyro
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sensor_gyro
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sensor_gyro
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sensor_gyro
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sensor_gyro
    ...
    def ORB_QUEUE_LENGTH(self):
        ...
        return Metaclass_SensorGyro.__constants['ORB_QUEUE_LENGTH']


class SensorGyro(metaclass=Metaclass_SensorGyro):
    """
    Message class 'SensorGyro'.
