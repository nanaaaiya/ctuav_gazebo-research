...
bool px4__msg__system_power__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._system_power.SystemPower", full_classname_dest, 33) == 0);
  }
  px4__msg__SystemPower * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__system_power__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of SystemPower */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._system_power");
  ...
  px4__msg__SystemPower * ros_message = (px4__msg__SystemPower *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
