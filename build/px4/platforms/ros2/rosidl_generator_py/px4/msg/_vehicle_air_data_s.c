...
bool px4__msg__vehicle_air_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._vehicle_air_data.VehicleAirData", full_classname_dest, 40) == 0);
  }
  px4__msg__VehicleAirData * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__vehicle_air_data__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VehicleAirData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._vehicle_air_data");
  ...
  px4__msg__VehicleAirData * ros_message = (px4__msg__VehicleAirData *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
