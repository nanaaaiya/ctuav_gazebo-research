...
bool px4__msg__vehicle_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._vehicle_imu.VehicleImu", full_classname_dest, 31) == 0);
  }
  px4__msg__VehicleImu * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__vehicle_imu__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VehicleImu */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._vehicle_imu");
  ...
  px4__msg__VehicleImu * ros_message = (px4__msg__VehicleImu *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
