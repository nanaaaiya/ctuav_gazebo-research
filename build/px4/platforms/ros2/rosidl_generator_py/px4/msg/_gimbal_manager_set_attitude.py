...
class Metaclass_GimbalManagerSetAttitude(type):
    """Metaclass of message 'GimbalManagerSetAttitude'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.GimbalManagerSetAttitude')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__gimbal_manager_set_attitude
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__gimbal_manager_set_attitude
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__gimbal_manager_set_attitude
            cls._TYPE_SUPPORT = module.type_support_msg__msg__gimbal_manager_set_attitude
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__gimbal_manager_set_attitude
    ...
    def GIMBAL_MANAGER_FLAGS_RETRACT(self):
        ...
        return Metaclass_GimbalManagerSetAttitude.__constants['GIMBAL_MANAGER_FLAGS_RETRACT']

    @property
    def GIMBAL_MANAGER_FLAGS_NEUTRAL(self):
        """Message constant 'GIMBAL_MANAGER_FLAGS_NEUTRAL'."""
        return Metaclass_GimbalManagerSetAttitude.__constants['GIMBAL_MANAGER_FLAGS_NEUTRAL']

    @property
    def GIMBAL_MANAGER_FLAGS_ROLL_LOCK(self):
        """Message constant 'GIMBAL_MANAGER_FLAGS_ROLL_LOCK'."""
        return Metaclass_GimbalManagerSetAttitude.__constants['GIMBAL_MANAGER_FLAGS_ROLL_LOCK']

    @property
    def GIMBAL_MANAGER_FLAGS_PITCH_LOCK(self):
        """Message constant 'GIMBAL_MANAGER_FLAGS_PITCH_LOCK'."""
        return Metaclass_GimbalManagerSetAttitude.__constants['GIMBAL_MANAGER_FLAGS_PITCH_LOCK']
