...
bool px4__msg__estimator_aid_source2d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._estimator_aid_source2d.EstimatorAidSource2d", full_classname_dest, 52) == 0);
  }
  px4__msg__EstimatorAidSource2d * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__estimator_aid_source2d__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorAidSource2d */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._estimator_aid_source2d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorAidSource2d");
  ...
  px4__msg__EstimatorAidSource2d * ros_message = (px4__msg__EstimatorAidSource2d *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
