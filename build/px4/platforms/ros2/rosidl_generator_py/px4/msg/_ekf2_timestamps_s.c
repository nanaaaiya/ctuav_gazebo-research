...
bool px4__msg__ekf2_timestamps__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._ekf2_timestamps.Ekf2Timestamps", full_classname_dest, 39) == 0);
  }
  px4__msg__Ekf2Timestamps * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__ekf2_timestamps__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Ekf2Timestamps */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._ekf2_timestamps");
  ...
  px4__msg__Ekf2Timestamps * ros_message = (px4__msg__Ekf2Timestamps *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
