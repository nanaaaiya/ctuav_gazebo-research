...
bool px4__msg__manual_control_switches__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._manual_control_switches.ManualControlSwitches", full_classname_dest, 54) == 0);
  }
  px4__msg__ManualControlSwitches * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__manual_control_switches__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ManualControlSwitches */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._manual_control_switches");
  ...
  px4__msg__ManualControlSwitches * ros_message = (px4__msg__ManualControlSwitches *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
