...
class Metaclass_DatamanRequest(type):
    """Metaclass of message 'DatamanRequest'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.DatamanRequest')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__dataman_request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__dataman_request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__dataman_request
            cls._TYPE_SUPPORT = module.type_support_msg__msg__dataman_request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__dataman_request
...
class DatamanRequest(metaclass=Metaclass_DatamanRequest):
    """Message class 'DatamanRequest'."""
    ...
    def data_length(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'data_length' field must be an unsigned integer in [0, 4294967295]"
