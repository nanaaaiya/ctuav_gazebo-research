...
bool px4__msg__estimator_status_flags__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._estimator_status_flags.EstimatorStatusFlags", full_classname_dest, 52) == 0);
  }
  px4__msg__EstimatorStatusFlags * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // cs_gnss_pos
    PyObject * field = PyObject_GetAttrString(_pymsg, "cs_gnss_pos");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->cs_gnss_pos = (Py_True == field);
    Py_DECREF(field);
  }
  {  // cs_opt_flow
  ...
  {  // cs_gnss_vel
    PyObject * field = PyObject_GetAttrString(_pymsg, "cs_gnss_vel");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->cs_gnss_vel = (Py_True == field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__estimator_status_flags__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorStatusFlags */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._estimator_status_flags");
  ...
  px4__msg__EstimatorStatusFlags * ros_message = (px4__msg__EstimatorStatusFlags *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // cs_gnss_pos
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->cs_gnss_pos ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cs_gnss_pos", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cs_gnss_vel
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->cs_gnss_vel ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cs_gnss_vel", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
