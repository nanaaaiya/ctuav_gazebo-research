...
bool px4__msg__fixed_wing_longitudinal_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._fixed_wing_longitudinal_setpoint.FixedWingLongitudinalSetpoint", full_classname_dest, 71) == 0);
  }
  px4__msg__FixedWingLongitudinalSetpoint * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__fixed_wing_longitudinal_setpoint__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FixedWingLongitudinalSetpoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._fixed_wing_longitudinal_setpoint");
  ...
  px4__msg__FixedWingLongitudinalSetpoint * ros_message = (px4__msg__FixedWingLongitudinalSetpoint *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
