...
class Metaclass_AirspeedValidated(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'GROUND_MINUS_WIND': cls.__constants['GROUND_MINUS_WIND'],
            'SENSOR_1': cls.__constants['SENSOR_1'],
            'SENSOR_2': cls.__constants['SENSOR_2'],
            'SENSOR_3': cls.__constants['SENSOR_3'],
            'SYNTHETIC': cls.__constants['SYNTHETIC'],
        }
    ...
    def DISABLED(self):
        ...
        return Metaclass_AirspeedValidated.__constants['DISABLED']

    @property
    def GROUND_MINUS_WIND(self):
        """Message constant 'GROUND_MINUS_WIND'."""
        return Metaclass_AirspeedValidated.__constants['GROUND_MINUS_WIND']

    @property
    def SENSOR_1(self):
        """Message constant 'SENSOR_1'."""
        return Metaclass_AirspeedValidated.__constants['SENSOR_1']

    @property
    def SENSOR_2(self):
        """Message constant 'SENSOR_2'."""
        return Metaclass_AirspeedValidated.__constants['SENSOR_2']

    @property
    def SENSOR_3(self):
        """Message constant 'SENSOR_3'."""
        return Metaclass_AirspeedValidated.__constants['SENSOR_3']

    @property
    def SYNTHETIC(self):
        """Message constant 'SYNTHETIC'."""
        return Metaclass_AirspeedValidated.__constants['SYNTHETIC']
