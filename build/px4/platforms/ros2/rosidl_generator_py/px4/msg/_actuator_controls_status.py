    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.ActuatorControlsStatus')
            logger.debug(
    ...
    def control_power(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'control_power' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
