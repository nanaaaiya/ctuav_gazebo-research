...
bool px4__msg__rover_rate_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._rover_rate_status.RoverRateStatus", full_classname_dest, 42) == 0);
  }
  px4__msg__RoverRateStatus * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__rover_rate_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RoverRateStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._rover_rate_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoverRateStatus");
  ...
  px4__msg__RoverRateStatus * ros_message = (px4__msg__RoverRateStatus *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
