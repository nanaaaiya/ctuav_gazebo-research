...
static const _FixedWingLongitudinalSetpoint_type_support_symbol_names_t _FixedWingLongitudinalSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, FixedWingLongitudinalSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, FixedWingLongitudinalSetpoint)),
  }
};
...
{
  return &::px4::msg::rosidl_typesupport_cpp::FixedWingLongitudinalSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4, msg, FixedWingLongitudinalSetpoint)() {
  return get_message_type_support_handle<px4::msg::FixedWingLongitudinalSetpoint>();
}
