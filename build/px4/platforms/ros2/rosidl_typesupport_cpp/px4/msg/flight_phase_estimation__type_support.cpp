...
static const _FlightPhaseEstimation_type_support_symbol_names_t _FlightPhaseEstimation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, FlightPhaseEstimation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, FlightPhaseEstimation)),
  }
};
...
get_message_type_support_handle<px4::msg::FlightPhaseEstimation>()
{
  return &::px4::msg::rosidl_typesupport_cpp::FlightPhaseEstimation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4, msg, FlightPhaseEstimation)() {
  return get_message_type_support_handle<px4::msg::FlightPhaseEstimation>();
}
