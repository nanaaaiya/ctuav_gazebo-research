...
static const _FigureEightStatus_type_support_symbol_names_t _FigureEightStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, FigureEightStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, FigureEightStatus)),
  }
};
...
get_message_type_support_handle<px4::msg::FigureEightStatus>()
{
  return &::px4::msg::rosidl_typesupport_cpp::FigureEightStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4, msg, FigureEightStatus)() {
  return get_message_type_support_handle<px4::msg::FigureEightStatus>();
}
