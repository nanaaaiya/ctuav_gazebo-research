...
#include "px4/msg/detail/fixed_wing_lateral_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::FixedWingLateralStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::FixedWingLateralStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::FixedWingLateralStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FixedWingLateralStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4::msg::FixedWingLateralStatus *>(
...
static size_t _FixedWingLateralStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FixedWingLateralStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FixedWingLateralStatus__callbacks = {
  "px4::msg",
...
static rosidl_message_type_support_t _FixedWingLateralStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FixedWingLateralStatus__callbacks,
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_FixedWingLateralStatus__handle;
}
