...
#include "px4/msg/detail/vehicle_attitude_setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::VehicleAttitudeSetpoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::VehicleAttitudeSetpoint & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::VehicleAttitudeSetpoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::VehicleAttitudeSetpoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::VehicleAttitudeSetpoint *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleAttitudeSetpoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, VehicleAttitudeSetpoint)() {
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleAttitudeSetpoint__handle;
}
