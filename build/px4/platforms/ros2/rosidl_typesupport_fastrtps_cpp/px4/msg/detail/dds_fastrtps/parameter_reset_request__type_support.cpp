...
#include "px4/msg/detail/parameter_reset_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::ParameterResetRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::ParameterResetRequest & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::ParameterResetRequest;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::ParameterResetRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::ParameterResetRequest *>(
    untyped_ros_message);
...
static size_t _ParameterResetRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ParameterResetRequest(full_bounded, is_plain, 0);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_ParameterResetRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, ParameterResetRequest)() {
  return &px4::msg::typesupport_fastrtps_cpp::_ParameterResetRequest__handle;
}
