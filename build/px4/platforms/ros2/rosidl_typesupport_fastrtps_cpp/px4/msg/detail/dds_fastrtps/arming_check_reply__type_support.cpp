...
#include "px4/msg/detail/arming_check_reply__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::ArmingCheckReply & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::ArmingCheckReply & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  // Member: events
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        px4::msg::typesupport_fastrtps_cpp::max_serialized_size_Event(
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::ArmingCheckReply;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::ArmingCheckReply *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::ArmingCheckReply *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_ArmingCheckReply__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, ArmingCheckReply)() {
  return &px4::msg::typesupport_fastrtps_cpp::_ArmingCheckReply__handle;
}
