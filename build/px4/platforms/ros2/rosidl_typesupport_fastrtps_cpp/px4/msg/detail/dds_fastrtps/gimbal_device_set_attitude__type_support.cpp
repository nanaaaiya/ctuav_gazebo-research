...
#include "px4/msg/detail/gimbal_device_set_attitude__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::GimbalDeviceSetAttitude & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::GimbalDeviceSetAttitude & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::GimbalDeviceSetAttitude;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::GimbalDeviceSetAttitude *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::GimbalDeviceSetAttitude *>(
    untyped_ros_message);
...
static size_t _GimbalDeviceSetAttitude__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GimbalDeviceSetAttitude(full_bounded, is_plain, 0);
...
get_message_type_support_handle<px4::msg::GimbalDeviceSetAttitude>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_GimbalDeviceSetAttitude__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, GimbalDeviceSetAttitude)() {
  return &px4::msg::typesupport_fastrtps_cpp::_GimbalDeviceSetAttitude__handle;
}
