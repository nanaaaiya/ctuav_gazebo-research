...
#include "px4/msg/detail/mag_worker_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::MagWorkerData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::MagWorkerData & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::MagWorkerData;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const px4::msg::MagWorkerData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::MagWorkerData *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_MagWorkerData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, MagWorkerData)() {
  return &px4::msg::typesupport_fastrtps_cpp::_MagWorkerData__handle;
}
