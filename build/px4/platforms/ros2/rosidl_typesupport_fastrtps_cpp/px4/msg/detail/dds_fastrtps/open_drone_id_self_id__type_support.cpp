...
#include "px4/msg/detail/open_drone_id_self_id__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::OpenDroneIdSelfId;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::OpenDroneIdSelfId *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::OpenDroneIdSelfId *>(
    untyped_ros_message);
...
static size_t _OpenDroneIdSelfId__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OpenDroneIdSelfId(full_bounded, is_plain, 0);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_OpenDroneIdSelfId__handle;
}
