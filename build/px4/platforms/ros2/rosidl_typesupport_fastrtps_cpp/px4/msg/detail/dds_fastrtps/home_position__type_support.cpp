...
#include "px4/msg/detail/home_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::HomePosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::HomePosition & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_HomePosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::HomePosition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::HomePosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::HomePosition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HomePosition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4::msg::HomePosition *>(
...
static size_t _HomePosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HomePosition(full_bounded, is_plain, 0);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_HomePosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, HomePosition)() {
  return &px4::msg::typesupport_fastrtps_cpp::_HomePosition__handle;
}
