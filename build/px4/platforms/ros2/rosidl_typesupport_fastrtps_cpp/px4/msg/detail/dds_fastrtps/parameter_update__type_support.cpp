...
#include "px4/msg/detail/parameter_update__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::ParameterUpdate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::ParameterUpdate & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::ParameterUpdate;
    is_plain =
      (
      offsetof(DataType, custom_default) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const px4::msg::ParameterUpdate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::ParameterUpdate *>(
    untyped_ros_message);
...
static size_t _ParameterUpdate__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ParameterUpdate(full_bounded, is_plain, 0);
...
get_message_type_support_handle<px4::msg::ParameterUpdate>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_ParameterUpdate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, ParameterUpdate)() {
  return &px4::msg::typesupport_fastrtps_cpp::_ParameterUpdate__handle;
}
