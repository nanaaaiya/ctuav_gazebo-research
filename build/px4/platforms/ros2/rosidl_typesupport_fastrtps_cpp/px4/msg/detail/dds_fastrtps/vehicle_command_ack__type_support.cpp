...
#include "px4/msg/detail/vehicle_command_ack__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::VehicleCommandAck & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::VehicleCommandAck & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::VehicleCommandAck;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::VehicleCommandAck *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::VehicleCommandAck *>(
    untyped_ros_message);
...
static size_t _VehicleCommandAck__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_VehicleCommandAck(full_bounded, is_plain, 0);
...
get_message_type_support_handle<px4::msg::VehicleCommandAck>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleCommandAck__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, VehicleCommandAck)() {
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleCommandAck__handle;
}
