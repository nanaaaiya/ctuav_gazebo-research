...
#include "px4/msg/detail/gpio_out__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::GpioOut & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::GpioOut;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::GpioOut *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_GpioOut__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, GpioOut)() {
  return &px4::msg::typesupport_fastrtps_cpp::_GpioOut__handle;
}
