...
#include "px4/msg/detail/debug_vect__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::DebugVect & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::DebugVect;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const px4::msg::DebugVect *>(
    untyped_ros_message);
...
static size_t _DebugVect__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_DebugVect(full_bounded, is_plain, 0);
...
get_message_type_support_handle<px4::msg::DebugVect>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_DebugVect__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, DebugVect)() {
  return &px4::msg::typesupport_fastrtps_cpp::_DebugVect__handle;
}
