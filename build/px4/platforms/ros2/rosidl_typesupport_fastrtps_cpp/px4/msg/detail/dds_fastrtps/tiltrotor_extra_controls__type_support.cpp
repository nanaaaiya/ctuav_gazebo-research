...
#include "px4/msg/detail/tiltrotor_extra_controls__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::TiltrotorExtraControls & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::TiltrotorExtraControls & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::TiltrotorExtraControls;
    is_plain =
      (
      offsetof(DataType, collective_thrust_normalized_setpoint) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const px4::msg::TiltrotorExtraControls *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::TiltrotorExtraControls *>(
    untyped_ros_message);
...
get_message_type_support_handle<px4::msg::TiltrotorExtraControls>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_TiltrotorExtraControls__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, TiltrotorExtraControls)() {
  return &px4::msg::typesupport_fastrtps_cpp::_TiltrotorExtraControls__handle;
}
