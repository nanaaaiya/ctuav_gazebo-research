...
#include "px4/msg/detail/ping__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::Ping & ros_message,
...
{
  auto typed_message =
    static_cast<const px4::msg::Ping *>(
    untyped_ros_message);
...
get_message_type_support_handle<px4::msg::Ping>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_Ping__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, Ping)() {
  return &px4::msg::typesupport_fastrtps_cpp::_Ping__handle;
}
