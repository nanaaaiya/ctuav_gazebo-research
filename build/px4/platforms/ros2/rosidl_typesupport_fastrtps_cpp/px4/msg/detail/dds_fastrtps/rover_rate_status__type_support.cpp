...
#include "px4/msg/detail/rover_rate_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::RoverRateStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::RoverRateStatus & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_RoverRateStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::RoverRateStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::RoverRateStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::RoverRateStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RoverRateStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4::msg::RoverRateStatus *>(
...
static size_t _RoverRateStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RoverRateStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RoverRateStatus__callbacks = {
  "px4::msg",
  "RoverRateStatus",
...
static rosidl_message_type_support_t _RoverRateStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RoverRateStatus__callbacks,
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_RoverRateStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, RoverRateStatus)() {
  return &px4::msg::typesupport_fastrtps_cpp::_RoverRateStatus__handle;
}
