...
#include "px4/msg/detail/sensor_uwb__rosidl_typesupport_fastrtps_cpp.hpp"
#include "px4/msg/detail/sensor_uwb__struct.hpp"
...
cdr_serialize(
  const px4::msg::SensorUwb & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::SensorUwb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::SensorUwb *>(
    untyped_ros_message);
...
get_message_type_support_handle<px4::msg::SensorUwb>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_SensorUwb__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, SensorUwb)() {
  return &px4::msg::typesupport_fastrtps_cpp::_SensorUwb__handle;
}
