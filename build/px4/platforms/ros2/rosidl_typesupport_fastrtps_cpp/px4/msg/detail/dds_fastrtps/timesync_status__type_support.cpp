...
#include "px4/msg/detail/timesync_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::TimesyncStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::TimesyncStatus & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_TimesyncStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::TimesyncStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::TimesyncStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::TimesyncStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TimesyncStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4::msg::TimesyncStatus *>(
...
static size_t _TimesyncStatus__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TimesyncStatus(full_bounded, is_plain, 0);
...
get_message_type_support_handle<px4::msg::TimesyncStatus>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_TimesyncStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, TimesyncStatus)() {
  return &px4::msg::typesupport_fastrtps_cpp::_TimesyncStatus__handle;
}
