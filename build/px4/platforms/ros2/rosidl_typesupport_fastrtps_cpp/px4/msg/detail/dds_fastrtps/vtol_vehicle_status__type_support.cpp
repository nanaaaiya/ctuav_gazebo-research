...
#include "px4/msg/detail/vtol_vehicle_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::VtolVehicleStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::VtolVehicleStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::VtolVehicleStatus *>(
    untyped_ros_message);
...
static size_t _VtolVehicleStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VtolVehicleStatus(full_bounded, is_plain, 0);
...
get_message_type_support_handle<px4::msg::VtolVehicleStatus>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_VtolVehicleStatus__handle;
}
