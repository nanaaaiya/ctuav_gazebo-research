...
#include "px4/msg/detail/open_drone_id_arm_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::OpenDroneIdArmStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::OpenDroneIdArmStatus & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::OpenDroneIdArmStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::OpenDroneIdArmStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::OpenDroneIdArmStatus *>(
    untyped_ros_message);
...
static size_t _OpenDroneIdArmStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OpenDroneIdArmStatus(full_bounded, is_plain, 0);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_OpenDroneIdArmStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, OpenDroneIdArmStatus)() {
  return &px4::msg::typesupport_fastrtps_cpp::_OpenDroneIdArmStatus__handle;
}
