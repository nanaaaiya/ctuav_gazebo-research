...
#include "px4/msg/detail/estimator_bias__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::EstimatorBias & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::EstimatorBias & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_EstimatorBias(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::EstimatorBias;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::EstimatorBias *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::EstimatorBias *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EstimatorBias__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4::msg::EstimatorBias *>(
...
static size_t _EstimatorBias__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EstimatorBias(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EstimatorBias__callbacks = {
  "px4::msg",
  "EstimatorBias",
...
static rosidl_message_type_support_t _EstimatorBias__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EstimatorBias__callbacks,
...
get_message_type_support_handle<px4::msg::EstimatorBias>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_EstimatorBias__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, EstimatorBias)() {
  return &px4::msg::typesupport_fastrtps_cpp::_EstimatorBias__handle;
}
