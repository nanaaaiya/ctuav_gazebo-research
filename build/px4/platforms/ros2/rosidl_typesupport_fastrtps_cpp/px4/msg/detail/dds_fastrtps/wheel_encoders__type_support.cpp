...
#include "px4/msg/detail/wheel_encoders__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::WheelEncoders & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::WheelEncoders & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 2;
    size_t item_size = sizeof(ros_message.wheel_speed[0]);
  ...
  {
    size_t array_size = 2;
    size_t item_size = sizeof(ros_message.wheel_angle[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::WheelEncoders;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::WheelEncoders *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::WheelEncoders *>(
    untyped_ros_message);
...
static size_t _WheelEncoders__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WheelEncoders(full_bounded, is_plain, 0);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_WheelEncoders__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, WheelEncoders)() {
  return &px4::msg::typesupport_fastrtps_cpp::_WheelEncoders__handle;
}
