...
#include "px4/msg/detail/fixed_wing_runway_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::FixedWingRunwayControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::FixedWingRunwayControl & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::FixedWingRunwayControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::FixedWingRunwayControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::FixedWingRunwayControl *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_FixedWingRunwayControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, FixedWingRunwayControl)() {
  return &px4::msg::typesupport_fastrtps_cpp::_FixedWingRunwayControl__handle;
}
