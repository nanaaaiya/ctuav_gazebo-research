...
#include "px4/msg/detail/hover_thrust_estimate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::HoverThrustEstimate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::HoverThrustEstimate & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_HoverThrustEstimate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::HoverThrustEstimate;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::HoverThrustEstimate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::HoverThrustEstimate *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HoverThrustEstimate__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4::msg::HoverThrustEstimate *>(
...
static size_t _HoverThrustEstimate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HoverThrustEstimate(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HoverThrustEstimate__callbacks = {
  "px4::msg",
  "HoverThrustEstimate",
...
static rosidl_message_type_support_t _HoverThrustEstimate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HoverThrustEstimate__callbacks,
...
get_message_type_support_handle<px4::msg::HoverThrustEstimate>()
{
  return &px4::msg::typesupport_fastrtps_cpp::_HoverThrustEstimate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, HoverThrustEstimate)() {
  return &px4::msg::typesupport_fastrtps_cpp::_HoverThrustEstimate__handle;
}
