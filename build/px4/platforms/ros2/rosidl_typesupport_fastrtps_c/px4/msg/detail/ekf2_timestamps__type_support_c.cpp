...
#include "px4/msg/detail/ekf2_timestamps__rosidl_typesupport_fastrtps_c.h"
...
using _Ekf2Timestamps__ros_msg_type = px4__msg__Ekf2Timestamps;
...
size_t get_serialized_size_px4__msg__Ekf2Timestamps(
  const void * untyped_ros_message,
...
static uint32_t _Ekf2Timestamps__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__Ekf2Timestamps(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__Ekf2Timestamps(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__Ekf2Timestamps;
    is_plain =
      (
...
static size_t _Ekf2Timestamps__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__Ekf2Timestamps(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, Ekf2Timestamps)() {
