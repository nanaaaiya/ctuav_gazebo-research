...
#include "px4/msg/detail/rover_rate_setpoint__rosidl_typesupport_fastrtps_c.h"
...
using _RoverRateSetpoint__ros_msg_type = px4__msg__RoverRateSetpoint;
...
static uint32_t _RoverRateSetpoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__RoverRateSetpoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__RoverRateSetpoint;
    is_plain =
      (
...
static size_t _RoverRateSetpoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__RoverRateSetpoint(
