...
#include "px4/msg/detail/neural_control__rosidl_typesupport_fastrtps_c.h"
...
using _NeuralControl__ros_msg_type = px4__msg__NeuralControl;
...
size_t get_serialized_size_px4__msg__NeuralControl(
  const void * untyped_ros_message,
...
static uint32_t _NeuralControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__NeuralControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__NeuralControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__NeuralControl;
    is_plain =
      (
...
static size_t _NeuralControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__NeuralControl(
...
static message_type_support_callbacks_t __callbacks_NeuralControl = {
  "px4::msg",
  "NeuralControl",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, NeuralControl)() {
  return &_NeuralControl__type_support;
}
