...
#include "px4/msg/detail/vehicle_optical_flow_vel__rosidl_typesupport_fastrtps_c.h"
...
#include "px4/msg/detail/vehicle_optical_flow_vel__struct.h"
...
using _VehicleOpticalFlowVel__ros_msg_type = px4__msg__VehicleOpticalFlowVel;
...
size_t get_serialized_size_px4__msg__VehicleOpticalFlowVel(
  const void * untyped_ros_message,
...
static uint32_t _VehicleOpticalFlowVel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__VehicleOpticalFlowVel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__VehicleOpticalFlowVel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__VehicleOpticalFlowVel;
    is_plain =
      (
...
static size_t _VehicleOpticalFlowVel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__VehicleOpticalFlowVel(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, VehicleOpticalFlowVel)() {
