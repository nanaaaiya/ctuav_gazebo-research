...
#include "px4/msg/detail/rover_speed_status__rosidl_typesupport_fastrtps_c.h"
...
using _RoverSpeedStatus__ros_msg_type = px4__msg__RoverSpeedStatus;
  ...
  void * untyped_ros_message)
{
  ...
  _RoverSpeedStatus__ros_msg_type * ros_message = static_cast<_RoverSpeedStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4__msg__RoverSpeedStatus(
  const void * untyped_ros_message,
...
static uint32_t _RoverSpeedStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__RoverSpeedStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__RoverSpeedStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__RoverSpeedStatus;
    is_plain =
      (
...
static size_t _RoverSpeedStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__RoverSpeedStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RoverSpeedStatus)() {
