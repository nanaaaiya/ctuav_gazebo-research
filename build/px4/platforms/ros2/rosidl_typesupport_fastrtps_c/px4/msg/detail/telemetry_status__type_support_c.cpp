...
#include "px4/msg/detail/telemetry_status__rosidl_typesupport_fastrtps_c.h"
...
using _TelemetryStatus__ros_msg_type = px4__msg__TelemetryStatus;
...
size_t get_serialized_size_px4__msg__TelemetryStatus(
  const void * untyped_ros_message,
...
static uint32_t _TelemetryStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__TelemetryStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__TelemetryStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__TelemetryStatus;
    is_plain =
      (
...
static size_t _TelemetryStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__TelemetryStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, TelemetryStatus)() {
