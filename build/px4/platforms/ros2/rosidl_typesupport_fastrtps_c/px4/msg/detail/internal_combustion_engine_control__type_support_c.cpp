...
#include "px4/msg/detail/internal_combustion_engine_control__rosidl_typesupport_fastrtps_c.h"
...
using _InternalCombustionEngineControl__ros_msg_type = px4__msg__InternalCombustionEngineControl;
...
static uint32_t _InternalCombustionEngineControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__InternalCombustionEngineControl(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__InternalCombustionEngineControl;
    is_plain =
      (
...
static size_t _InternalCombustionEngineControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__InternalCombustionEngineControl(
