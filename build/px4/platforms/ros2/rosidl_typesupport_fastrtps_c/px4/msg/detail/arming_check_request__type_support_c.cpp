...
#include "px4/msg/detail/arming_check_request__rosidl_typesupport_fastrtps_c.h"
...
using _ArmingCheckRequest__ros_msg_type = px4__msg__ArmingCheckRequest;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: valid_registrations_mask
  {
...
size_t get_serialized_size_px4__msg__ArmingCheckRequest(
  const void * untyped_ros_message,
...
static uint32_t _ArmingCheckRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__ArmingCheckRequest(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__ArmingCheckRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__ArmingCheckRequest;
    is_plain =
      (
      offsetof(DataType, valid_registrations_mask) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ArmingCheckRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__ArmingCheckRequest(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, ArmingCheckRequest)() {
