...
#include "px4/msg/detail/rtl_status__rosidl_typesupport_fastrtps_c.h"
...
using _RtlStatus__ros_msg_type = px4__msg__RtlStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RtlStatus__ros_msg_type * ros_message = static_cast<const _RtlStatus__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: is_evaluation_pending
  {
    cdr << (ros_message->is_evaluation_pending ? true : false);
  }

  // Field name: has_vtol_approach
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RtlStatus__ros_msg_type * ros_message = static_cast<_RtlStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4__msg__RtlStatus(
  const void * untyped_ros_message,
...
static uint32_t _RtlStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__RtlStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__RtlStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__RtlStatus;
    is_plain =
      (
...
static size_t _RtlStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__RtlStatus(
...
static message_type_support_callbacks_t __callbacks_RtlStatus = {
  "px4::msg",
  "RtlStatus",
...
static rosidl_message_type_support_t _RtlStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RtlStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RtlStatus)() {
  return &_RtlStatus__type_support;
}
