...
#include "px4/msg/detail/arming_check_reply__rosidl_typesupport_fastrtps_c.h"
...
#include "px4/msg/detail/event__functions.h"  // events

// forward declare type support functions
size_t get_serialized_size_px4__msg__Event(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_px4__msg__Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, Event)();


using _ArmingCheckReply__ros_msg_type = px4__msg__ArmingCheckReply;
  ...
  // Field name: events
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, px4, msg, Event
      )()->data);
    size_t size = 5;
...
size_t get_serialized_size_px4__msg__ArmingCheckReply(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArmingCheckReply__ros_msg_type * ros_message = static_cast<const _ArmingCheckReply__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name events
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_px4__msg__Event(
...
static uint32_t _ArmingCheckReply__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__ArmingCheckReply(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__ArmingCheckReply(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: events
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_px4__msg__Event(
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__ArmingCheckReply;
    is_plain =
      (
...
static size_t _ArmingCheckReply__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__ArmingCheckReply(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, ArmingCheckReply)() {
