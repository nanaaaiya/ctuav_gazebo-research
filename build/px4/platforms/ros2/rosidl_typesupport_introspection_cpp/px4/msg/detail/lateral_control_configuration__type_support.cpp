...
{
  new (message_memory) px4::msg::LateralControlConfiguration(_init);
}

void LateralControlConfiguration_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::LateralControlConfiguration *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LateralControlConfiguration_message_member_array[2] = {
  {
    ...
    offsetof(px4::msg::LateralControlConfiguration, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::LateralControlConfiguration, lateral_accel_max),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LateralControlConfiguration_message_members = {
  ...
  2,  // number of fields
  sizeof(px4::msg::LateralControlConfiguration),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::LateralControlConfiguration_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, LateralControlConfiguration)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::LateralControlConfiguration_message_type_support_handle;
}
