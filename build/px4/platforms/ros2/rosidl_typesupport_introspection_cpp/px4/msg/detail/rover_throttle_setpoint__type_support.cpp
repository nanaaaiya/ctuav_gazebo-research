...
{
  new (message_memory) px4::msg::RoverThrottleSetpoint(_init);
}

void RoverThrottleSetpoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::RoverThrottleSetpoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverThrottleSetpoint_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::RoverThrottleSetpoint, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RoverThrottleSetpoint, throttle_body_x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RoverThrottleSetpoint, throttle_body_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverThrottleSetpoint_message_members = {
  ...
  3,  // number of fields
  sizeof(px4::msg::RoverThrottleSetpoint),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RoverThrottleSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, RoverThrottleSetpoint)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RoverThrottleSetpoint_message_type_support_handle;
}
