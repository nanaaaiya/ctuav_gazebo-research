...
{
  new (message_memory) px4::msg::BatteryInfo(_init);
}

void BatteryInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::BatteryInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryInfo_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::BatteryInfo, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::BatteryInfo, id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::BatteryInfo, serial_number),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::BatteryInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, BatteryInfo)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::BatteryInfo_message_type_support_handle;
}
