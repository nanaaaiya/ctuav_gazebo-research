...
{
  new (message_memory) px4::msg::RoverSteeringSetpoint(_init);
}

void RoverSteeringSetpoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::RoverSteeringSetpoint *>(message_memory);
  typed_message->~RoverSteeringSetpoint();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverSteeringSetpoint_message_member_array[2] = {
  {
    "timestamp",  // name
    ...
    offsetof(px4::msg::RoverSteeringSetpoint, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RoverSteeringSetpoint, normalized_steering_setpoint),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverSteeringSetpoint_message_members = {
  ...
  2,  // number of fields
  sizeof(px4::msg::RoverSteeringSetpoint),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RoverSteeringSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, RoverSteeringSetpoint)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RoverSteeringSetpoint_message_type_support_handle;
}
