...
{
  new (message_memory) px4::msg::TrajectorySetpoint6dof(_init);
}

void TrajectorySetpoint6dof_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::TrajectorySetpoint6dof *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectorySetpoint6dof_message_member_array[7] = {
  {
    ...
    offsetof(px4::msg::TrajectorySetpoint6dof, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectorySetpoint6dof, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectorySetpoint6dof, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectorySetpoint6dof, acceleration),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectorySetpoint6dof, jerk),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectorySetpoint6dof, quaternion),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectorySetpoint6dof, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectorySetpoint6dof_message_members = {
  ...
  7,  // number of fields
  sizeof(px4::msg::TrajectorySetpoint6dof),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::TrajectorySetpoint6dof_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, TrajectorySetpoint6dof)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::TrajectorySetpoint6dof_message_type_support_handle;
}
