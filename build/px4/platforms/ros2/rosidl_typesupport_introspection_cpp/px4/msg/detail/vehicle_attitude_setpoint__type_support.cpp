...
{
  new (message_memory) px4::msg::VehicleAttitudeSetpoint(_init);
}

void VehicleAttitudeSetpoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::VehicleAttitudeSetpoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleAttitudeSetpoint_message_member_array[4] = {
  {
    "timestamp",  // name
    ...
    offsetof(px4::msg::VehicleAttitudeSetpoint, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleAttitudeSetpoint, yaw_sp_move_rate),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleAttitudeSetpoint, q_d),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleAttitudeSetpoint, thrust_body),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleAttitudeSetpoint_message_members = {
  ...
  4,  // number of fields
  sizeof(px4::msg::VehicleAttitudeSetpoint),
...
get_message_type_support_handle<px4::msg::VehicleAttitudeSetpoint>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleAttitudeSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, VehicleAttitudeSetpoint)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleAttitudeSetpoint_message_type_support_handle;
}
