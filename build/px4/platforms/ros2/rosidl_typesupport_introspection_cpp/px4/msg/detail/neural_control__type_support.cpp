...
{
  new (message_memory) px4::msg::NeuralControl(_init);
}

void NeuralControl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::NeuralControl *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NeuralControl_message_member_array[5] = {
  {
    ...
    offsetof(px4::msg::NeuralControl, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    15,  // array size
    false,  // is upper bound
    offsetof(px4::msg::NeuralControl, observation),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::NeuralControl, network_output),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::NeuralControl, controller_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::NeuralControl, inference_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::NeuralControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, NeuralControl)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::NeuralControl_message_type_support_handle;
}
