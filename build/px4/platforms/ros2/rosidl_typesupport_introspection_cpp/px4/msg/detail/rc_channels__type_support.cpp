...
{
  new (message_memory) px4::msg::RcChannels(_init);
}

void RcChannels_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::RcChannels *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RcChannels_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::RcChannels, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RcChannels, timestamp_last_valid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    18,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RcChannels, channels),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RcChannels, channel_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    30,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RcChannels, function),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RcChannels, rssi),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RcChannels, signal_lost),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RcChannels, frame_drop_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<px4::msg::RcChannels>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RcChannels_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, RcChannels)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RcChannels_message_type_support_handle;
}
