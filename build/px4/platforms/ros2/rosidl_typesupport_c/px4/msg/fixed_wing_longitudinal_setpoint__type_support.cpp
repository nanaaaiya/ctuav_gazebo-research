...
#include "px4/msg/detail/fixed_wing_longitudinal_setpoint__type_support.h"
...
static const _FixedWingLongitudinalSetpoint_type_support_symbol_names_t _FixedWingLongitudinalSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, FixedWingLongitudinalSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, FixedWingLongitudinalSetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, FixedWingLongitudinalSetpoint)() {
  return &::px4::msg::rosidl_typesupport_c::FixedWingLongitudinalSetpoint_message_type_support_handle;
}
