...
#include "px4/msg/detail/lateral_control_configuration__type_support.h"
...
static const _LateralControlConfiguration_type_support_symbol_names_t _LateralControlConfiguration_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, LateralControlConfiguration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, LateralControlConfiguration)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, LateralControlConfiguration)() {
  return &::px4::msg::rosidl_typesupport_c::LateralControlConfiguration_message_type_support_handle;
}
