...
#include "px4/msg/detail/open_drone_id_self_id__type_support.h"
...
static const _OpenDroneIdSelfId_type_support_symbol_names_t _OpenDroneIdSelfId_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, OpenDroneIdSelfId)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, OpenDroneIdSelfId)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, OpenDroneIdSelfId)() {
  return &::px4::msg::rosidl_typesupport_c::OpenDroneIdSelfId_message_type_support_handle;
}
