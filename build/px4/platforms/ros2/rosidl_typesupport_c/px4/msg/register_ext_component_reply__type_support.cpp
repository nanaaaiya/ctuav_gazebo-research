...
#include "px4/msg/detail/register_ext_component_reply__type_support.h"
...
static const _RegisterExtComponentReply_type_support_symbol_names_t _RegisterExtComponentReply_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RegisterExtComponentReply)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, RegisterExtComponentReply)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, RegisterExtComponentReply)() {
  return &::px4::msg::rosidl_typesupport_c::RegisterExtComponentReply_message_type_support_handle;
}
