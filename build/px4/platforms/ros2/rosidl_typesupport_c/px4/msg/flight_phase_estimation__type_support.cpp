...
static const _FlightPhaseEstimation_type_support_symbol_names_t _FlightPhaseEstimation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, FlightPhaseEstimation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, FlightPhaseEstimation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, FlightPhaseEstimation)() {
  return &::px4::msg::rosidl_typesupport_c::FlightPhaseEstimation_message_type_support_handle;
}
