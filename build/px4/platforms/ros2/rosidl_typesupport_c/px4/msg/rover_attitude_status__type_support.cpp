...
#include "px4/msg/detail/rover_attitude_status__type_support.h"
...
static const _RoverAttitudeStatus_type_support_symbol_names_t _RoverAttitudeStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RoverAttitudeStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, RoverAttitudeStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, RoverAttitudeStatus)() {
  return &::px4::msg::rosidl_typesupport_c::RoverAttitudeStatus_message_type_support_handle;
}
