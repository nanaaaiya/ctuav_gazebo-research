...
#include "px4/msg/detail/parameter_set_value_request__type_support.h"
...
static const _ParameterSetValueRequest_type_support_symbol_names_t _ParameterSetValueRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, ParameterSetValueRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, ParameterSetValueRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, ParameterSetValueRequest)() {
  return &::px4::msg::rosidl_typesupport_c::ParameterSetValueRequest_message_type_support_handle;
}
