...
#include "px4/msg/detail/figure_eight_status__type_support.h"
...
static const _FigureEightStatus_type_support_symbol_names_t _FigureEightStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, FigureEightStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, FigureEightStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, FigureEightStatus)() {
  return &::px4::msg::rosidl_typesupport_c::FigureEightStatus_message_type_support_handle;
}
