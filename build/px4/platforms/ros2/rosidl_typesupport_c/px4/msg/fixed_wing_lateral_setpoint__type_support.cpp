...
#include "px4/msg/detail/fixed_wing_lateral_setpoint__type_support.h"
...
static const _FixedWingLateralSetpoint_type_support_symbol_names_t _FixedWingLateralSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, FixedWingLateralSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, FixedWingLateralSetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, FixedWingLateralSetpoint)() {
  return &::px4::msg::rosidl_typesupport_c::FixedWingLateralSetpoint_message_type_support_handle;
}
