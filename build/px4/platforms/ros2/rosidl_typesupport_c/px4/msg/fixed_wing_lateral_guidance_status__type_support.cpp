...
#include "px4/msg/detail/fixed_wing_lateral_guidance_status__type_support.h"
...
static const _FixedWingLateralGuidanceStatus_type_support_symbol_names_t _FixedWingLateralGuidanceStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, FixedWingLateralGuidanceStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, FixedWingLateralGuidanceStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, FixedWingLateralGuidanceStatus)() {
  return &::px4::msg::rosidl_typesupport_c::FixedWingLateralGuidanceStatus_message_type_support_handle;
}
