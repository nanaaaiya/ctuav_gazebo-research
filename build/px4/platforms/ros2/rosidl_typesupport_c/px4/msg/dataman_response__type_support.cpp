...
#include "px4/msg/detail/dataman_response__type_support.h"
...
static const _DatamanResponse_type_support_symbol_names_t _DatamanResponse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, DatamanResponse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, DatamanResponse)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, DatamanResponse)() {
  return &::px4::msg::rosidl_typesupport_c::DatamanResponse_message_type_support_handle;
}
