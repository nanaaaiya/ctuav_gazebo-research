...
#include "px4/msg/detail/open_drone_id_operator_id__type_support.h"
...
static const _OpenDroneIdOperatorId_type_support_symbol_names_t _OpenDroneIdOperatorId_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, OpenDroneIdOperatorId)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, OpenDroneIdOperatorId)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, OpenDroneIdOperatorId)() {
  return &::px4::msg::rosidl_typesupport_c::OpenDroneIdOperatorId_message_type_support_handle;
}
